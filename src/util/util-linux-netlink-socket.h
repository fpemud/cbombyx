...
#ifndef __UTIL_LINUX_NETLINK_SOCKET_H__
#define __UTIL_LINUX_NETLINK_SOCKET_H__
...
{
	assert (payload >= 0 && payload < G_MAXINT - NLMSG_HDRLEN - 4);
...
#endif /* __UTIL_LINUX_NETLINK_SOCKET_H__ */

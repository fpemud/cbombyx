...
struct _ByxDBusInterfaceInfoExtended;
struct _ByxDBusMethodInfoExtended;

struct _ByxDBusPropertyInfoExtendedBase {
...
struct _ByxDBusPropertyInfoExtendedReadWritable {
	struct _ByxDBusPropertyInfoExtendedBase _base;
...
typedef struct {
	union {
		...
		GDBusPropertyInfo _parent;
		struct _ByxDBusPropertyInfoExtendedBase _base;
		struct _ByxDBusPropertyInfoExtendedReadWritable writable;
...
} ByxDBusPropertyInfoExtended;

G_STATIC_ASSERT (G_STRUCT_OFFSET (ByxDBusPropertyInfoExtended, property_name) == G_STRUCT_OFFSET (struct _ByxDBusPropertyInfoExtendedBase, property_name));
G_STATIC_ASSERT (G_STRUCT_OFFSET (ByxDBusPropertyInfoExtended, include_in_legacy_property_changed) == G_STRUCT_OFFSET (struct _ByxDBusPropertyInfoExtendedBase, include_in_legacy_property_changed));
...
#define NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_FULL(m_name, m_signature, m_property_name, m_include_in_legacy_property_changed) \
	((GDBusPropertyInfo *) &((const struct _ByxDBusPropertyInfoExtendedBase) { \
		._parent = { \
			.ref_count = -1, \
			.name = m_name, \
...
#define NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READWRITABLE_FULL(m_name, m_signature, m_property_name, m_permission, m_audit_op, m_include_in_legacy_property_changed) \
	((GDBusPropertyInfo *) &((const struct _ByxDBusPropertyInfoExtendedReadWritable) { \
		._base = { \
			._parent = { \
				.ref_count = -1, \
				.name = m_name, \
...
typedef struct _ByxDBusMethodInfoExtended {
	GDBusMethodInfo parent;
	void (*handle) (ByxDBusObject *obj,
	                const struct _ByxDBusInterfaceInfoExtended *interface_info,
	                const struct _ByxDBusMethodInfoExtended *method_info,
...
typedef struct _ByxDBusInterfaceInfoExtended {

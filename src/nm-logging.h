...
void     byx_logging_syslog_openlog (const char *logging_backend, gboolean debug);
gboolean byx_logging_syslog_enabled (void);

/*****************************************************************************/

/* This is the default definition of _NMLOG_ENABLED(). Special implementations
 * might want to undef this and redefine it. */
#define _NMLOG_ENABLED(level) ( byx_logging_enabled ((level), (_NMLOG_DOMAIN)) )
...
#define _NMLOG2_ENABLED(level) ( byx_logging_enabled ((level), (_NMLOG2_DOMAIN)) )
...
#define _NMLOG3_ENABLED(level) ( byx_logging_enabled ((level), (_NMLOG3_DOMAIN)) )

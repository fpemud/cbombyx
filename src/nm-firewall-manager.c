...
#define NM_FIREWALL_MANAGER_GET_PRIVATE(self) _BYX_GET_PRIVATE (self, NMFirewallManager, NM_IS_FIREWALL_MANAGER)

/*****************************************************************************/

BYX_DEFINE_SINGLETON_GETTER (NMFirewallManager, nm_firewall_manager_get, NM_TYPE_FIREWALL_MANAGER);
...
nm_firewall_manager_cancel_call (NMFirewallManagerCallId call)
{
	...
	byx_utils_error_set_cancelled (&error, FALSE, "NMFirewallManager");

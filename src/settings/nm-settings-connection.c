...
#define NM_SETTINGS_CONNECTION_GET_PRIVATE(self) _BYX_GET_PRIVATE_PTR (self, NMSettingsConnection, NM_IS_SETTINGS_CONNECTION)
...
#define _NMLOG(level, ...) \
    G_STMT_START { \
        ...
        if (byx_logging_enabled (__level, _NMLOG_DOMAIN)) { \
            ...
            _byx_log (__level, _NMLOG_DOMAIN, 0, NULL, __uuid, \
...
static const ByxDBusInterfaceInfoExtended interface_info_settings_connection;
                               ...
                               GError **error)
{
	...
	if (   replace_connection
		...
		if (log_diff_name) {
			byx_utils_log_connection_diff (replace_connection, NM_CONNECTION (self), LOGL_DEBUG, LOGD_CORE, log_diff_name, "++ ",
                     ...
                     gboolean is_disposing)
{
	...
	byx_utils_error_set_cancelled (&error, is_disposing, "NMSettingsConnection");
...
static void
impl_settings_connection_get_settings (ByxDBusObject *obj,
...
static void
impl_settings_connection_update (ByxDBusObject *obj,
                                 const ByxDBusInterfaceInfoExtended *interface_info,
                                 const NMDBusMethodInfoExtended *method_info,
                                 GDBusConnection *connection,
                                 const char *sender,
...
static void
impl_settings_connection_update_unsaved (ByxDBusObject *obj,
                                         const ByxDBusInterfaceInfoExtended *interface_info,
                                         const NMDBusMethodInfoExtended *method_info,
                                         GDBusConnection *connection,
                                         const char *sender,
...
static void
impl_settings_connection_save (ByxDBusObject *obj,
                               const ByxDBusInterfaceInfoExtended *interface_info,
                               const NMDBusMethodInfoExtended *method_info,
                               GDBusConnection *connection,
                               const char *sender,
...
static void
impl_settings_connection_update2 (ByxDBusObject *obj,
                                  const ByxDBusInterfaceInfoExtended *interface_info,
                                  const NMDBusMethodInfoExtended *method_info,
                                  GDBusConnection *connection,
                                  const char *sender,
                                  ...
                                  GVariant *parameters)
{
	...
	if (   (   NM_FLAGS_ANY (flags, ALL_PERSIST_MODES)
	        && !byx_utils_is_power_of_two (flags & ALL_PERSIST_MODES))
...
static void
impl_settings_connection_delete (ByxDBusObject *obj,
                                 const ByxDBusInterfaceInfoExtended *interface_info,
                                 const NMDBusMethodInfoExtended *method_info,
                                 GDBusConnection *connection,
                                 const char *sender,
...
static void
impl_settings_connection_get_secrets (ByxDBusObject *obj,
                                      const ByxDBusInterfaceInfoExtended *interface_info,
                                      const NMDBusMethodInfoExtended *method_info,
                                      GDBusConnection *connection,
                                      const char *sender,
...
static void
impl_settings_connection_clear_secrets (ByxDBusObject *obj,
                                        const ByxDBusInterfaceInfoExtended *interface_info,
                                        const NMDBusMethodInfoExtended *method_info,
                                        GDBusConnection *connection,
                                        const char *sender,
...
nm_settings_connection_cmp_timestamp (NMSettingsConnection *a, NMSettingsConnection *b)
{
	...
	if ((c = _cmp_timestamp (a, b)))
		return c;
	if ((c = byx_utils_cmp_connection_by_autoconnect_priority (NM_CONNECTION (a), NM_CONNECTION (b))))
		return c;
...
nm_settings_connection_read_and_fill_timestamp (NMSettingsConnection *self)
{
	...
	timestamp = _byx_utils_ascii_str_to_int64 (tmp_str, 10, 0, G_MAXINT64, -1);
	if (timestamp < 0) {
                          ...
                          gboolean is_reset)
{
	...
	if (retries)
		...
		priv->autoconnect_retries_blocked_until = byx_utils_get_monotonic_timestamp_s () + AUTOCONNECT_RESET_RETRIES_TIMER;
	}
}

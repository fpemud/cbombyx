...
_LOG_DECLARE_SELF (ByxConnection);
...
#define BYX_CONNECTION_AUTH_RETRIES_UNSET    -1
#define BYX_CONNECTION_AUTH_RETRIES_INFINITY -2
#define BYX_CONNECTION_AUTH_RETRIES_DEFAULT  3

/*****************************************************************************/

typedef void (*ActivationHandleFunc) (ByxConnection *self);
...
typedef void (*AcdCallback) (ByxConnection *, NMIP4Config **, gboolean);
...
struct _ByxConnectionConnectivityHandle {
	CList concheck_lst;
	ByxConnection *self;
...
NM_GOBJECT_PROPERTIES_DEFINE (ByxConnection,
	PROP_UDI,
	PROP_IFACE,
	PROP_IP_IFACE,
	PROP_DRIVER,
...
typedef struct _ByxConnectionPrivate {
	...
	ByxConnectionStateReason state_reason;
	struct {
		guint id;
	...
	char *        ip_iface;
	int           ip_ifindex;
	ByxConnectionType  type;
	char *        type_desc;
	NMLinkType    link_type;
	ByxConnectionCapabilities capabilities;
	char *        driver;
	char *        driver_version;
	...
	struct {
		guint               call_id;
		ByxConnectionStateReason available_reason;
		ByxConnectionStateReason unavailable_reason;
	}               recheck_available;
	struct {
		guint               call_id;
		ByxConnectionState       post_state;
		ByxConnectionStateReason post_state_reason;
	}               dispatcher;
	...
	ByxConnectionMtuSource mtu_source;
	...
	ByxConnectionSysIfaceState sys_iface_state:2;

	bool            v4_route_table_initialized:1;
	bool            v6_route_table_initialized:1;

	ByxConnectionAutoconnectBlockedFlags autoconnect_blocked_flags:4;
...
} ByxConnectionPrivate;

G_DEFINE_ABSTRACT_TYPE (ByxConnection, nm_device, NM_TYPE_DBUS_OBJECT)

#define BYX_CONNECTION_GET_PRIVATE(self) _BYX_GET_PRIVATE_PTR(self, ByxConnection, BYX_IS_CONNECTION)
...
static gboolean byx_connection_set_ip_config (ByxConnection *self,
                                         int addr_family,
                                         NMIPConfig *config,
                                         gboolean commit,
                                         GPtrArray *ip4_dev_route_blacklist);

static gboolean ip_config_merge_and_apply (ByxConnection *self,
                                           int addr_family,
                                           gboolean commit);

static gboolean byx_connection_master_add_slave (ByxConnection *self, ByxConnection *slave, gboolean configure);
static void byx_connection_slave_notify_enslave (ByxConnection *self, gboolean success);
static void byx_connection_slave_notify_release (ByxConnection *self, ByxConnectionStateReason reason);

static void addrconf6_start_with_link_ready (ByxConnection *self);
static gboolean linklocal6_start (ByxConnection *self);

static void _carrier_wait_check_queued_act_request (ByxConnection *self);
static gint64 _get_carrier_wait_ms (ByxConnection *self);

static const char *_activation_func_to_string (ActivationHandleFunc func);
static void activation_source_handle_cb (ByxConnection *self, int addr_family);

static void _set_state_full (ByxConnection *self,
                             ByxConnectionState state,
                             ByxConnectionStateReason reason,
                             gboolean quitting);
static void queued_state_clear (ByxConnection *device);
...
static gboolean ip_config_valid (ByxConnectionState state);
static NMActStageReturn dhcp4_start (ByxConnection *self);
static gboolean dhcp6_start (ByxConnection *self, gboolean wait_for_ll);
static void byx_connection_start_ip_check (ByxConnection *self);
static void realize_start_setup (ByxConnection *self,
                                 const NMPlatformLink *plink,
                                 gboolean assume_state_guess_assume,
                                 const char *assume_state_connection_uuid,
                                 gboolean set_nm_owned,
                                 NMUnmanFlagOp unmanaged_user_explicit);
static void _set_mtu (ByxConnection *self, guint32 mtu);
static void _commit_mtu (ByxConnection *self, const NMIP4Config *config);
static void _cancel_activation (ByxConnection *self);

static void concheck_update_state (ByxConnection *self, NMConnectivityState state, gboolean is_periodic);

/*****************************************************************************/

NM_UTILS_LOOKUP_STR_DEFINE_STATIC (queued_state_to_string, ByxConnectionState,
	NM_UTILS_LOOKUP_DEFAULT  (                              NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "???"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_UNKNOWN,      NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "unknown"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_UNMANAGED,    NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "unmanaged"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_UNAVAILABLE,  NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "unavailable"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_DISCONNECTED, NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "disconnected"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_PREPARE,      NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "prepare"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_CONFIG,       NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "config"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_NEED_AUTH,    NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "need-auth"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_IP_CONFIG,    NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "ip-config"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_IP_CHECK,     NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "ip-check"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_SECONDARIES,  NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "secondaries"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_ACTIVATED,    NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "activated"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_DEACTIVATING, NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "deactivating"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_FAILED,       NM_PENDING_ACTIONPREFIX_QUEUED_STATE_CHANGE "failed"),
);
...
NM_UTILS_LOOKUP_STR_DEFINE (byx_connection_state_reason_to_str, ByxConnectionStateReason,
	...
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_UNKNOWN,                        "unknown"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_NONE,                           "none"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_NOW_MANAGED,                    "managed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_NOW_UNMANAGED,                  "unmanaged"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_CONFIG_FAILED,                  "config-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_IP_CONFIG_UNAVAILABLE,          "ip-config-unavailable"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_IP_CONFIG_EXPIRED,              "ip-config-expired"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_NO_SECRETS,                     "no-secrets"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SUPPLICANT_DISCONNECT,          "supplicant-disconnect"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SUPPLICANT_CONFIG_FAILED,       "supplicant-config-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SUPPLICANT_FAILED,              "supplicant-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SUPPLICANT_TIMEOUT,             "supplicant-timeout"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_PPP_START_FAILED,               "ppp-start-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_PPP_DISCONNECT,                 "ppp-disconnect"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_PPP_FAILED,                     "ppp-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_DHCP_START_FAILED,              "dhcp-start-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_DHCP_ERROR,                     "dhcp-error"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_DHCP_FAILED,                    "dhcp-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SHARED_START_FAILED,            "sharing-start-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SHARED_FAILED,                  "sharing-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_AUTOIP_START_FAILED,            "autoip-start-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_AUTOIP_ERROR,                   "autoip-error"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_AUTOIP_FAILED,                  "autoip-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_BUSY,                     "modem-busy"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_NO_DIAL_TONE,             "modem-no-dialtone"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_NO_CARRIER,               "modem-no-carrier"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_DIAL_TIMEOUT,             "modem-dial-timeout"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_DIAL_FAILED,              "modem-dial-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_INIT_FAILED,              "modem-init-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_APN_FAILED,                 "gsm-apn-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_REGISTRATION_NOT_SEARCHING, "gsm-registration-idle"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_REGISTRATION_DENIED,        "gsm-registration-denied"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_REGISTRATION_TIMEOUT,       "gsm-registration-timeout"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_REGISTRATION_FAILED,        "gsm-registration-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_PIN_CHECK_FAILED,           "gsm-pin-check-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_FIRMWARE_MISSING,               "firmware-missing"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_REMOVED,                        "removed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SLEEPING,                       "sleeping"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_CONNECTION_REMOVED,             "connection-removed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_USER_REQUESTED,                 "user-requested"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_CARRIER,                        "carrier-changed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_CONNECTION_ASSUMED,             "connection-assumed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SUPPLICANT_AVAILABLE,           "supplicant-available"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_NOT_FOUND,                "modem-not-found"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_BT_FAILED,                      "bluetooth-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_SIM_NOT_INSERTED,           "gsm-sim-not-inserted"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_SIM_PIN_REQUIRED,           "gsm-sim-pin-required"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_SIM_PUK_REQUIRED,           "gsm-sim-puk-required"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_GSM_SIM_WRONG,                  "gsm-sim-wrong"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_INFINIBAND_MODE,                "infiniband-mode"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_DEPENDENCY_FAILED,              "dependency-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_BR2684_FAILED,                  "br2684-bridge-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_MANAGER_UNAVAILABLE,      "modem-manager-unavailable"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SSID_NOT_FOUND,                 "ssid-not-found"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SECONDARY_CONNECTION_FAILED,    "secondary-connection-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_DCB_FCOE_FAILED,                "dcb-fcoe-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_TEAMD_CONTROL_FAILED,           "teamd-control-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_FAILED,                   "modem-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_MODEM_AVAILABLE,                "modem-available"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_SIM_PIN_INCORRECT,              "sim-pin-incorrect"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_NEW_ACTIVATION,                 "new-activation"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_PARENT_CHANGED,                 "parent-changed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_PARENT_MANAGED_CHANGED,         "parent-managed-changed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_OVSDB_FAILED,                   "ovsdb-failed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_IP_ADDRESS_DUPLICATE,           "ip-address-duplicate"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_STATE_REASON_IP_METHOD_UNSUPPORTED,          "ip-method-unsupported"),
);

#define reason_to_string(reason) \
	NM_UTILS_LOOKUP_STR (byx_connection_state_reason_to_str, reason)

NM_UTILS_LOOKUP_STR_DEFINE_STATIC (mtu_source_to_str, ByxConnectionMtuSource,
	NM_UTILS_LOOKUP_DEFAULT_NM_ASSERT ("unknown"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_MTU_SOURCE_NONE,       "none"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_MTU_SOURCE_PARENT,     "parent"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_MTU_SOURCE_IP_CONFIG,  "ip-config"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_MTU_SOURCE_CONNECTION, "connection"),
);

/*****************************************************************************/

NMSettings *
byx_connection_get_settings (ByxConnection *self)
{
	return BYX_CONNECTION_GET_PRIVATE (self)->settings;
}

NMNetns *
byx_connection_get_netns (ByxConnection *self)
{
	return BYX_CONNECTION_GET_PRIVATE (self)->netns;
}

NMDedupMultiIndex *
byx_connection_get_multi_index (ByxConnection *self)
{
	return nm_netns_get_multi_idx (byx_connection_get_netns (self));
}

NMPlatform *
byx_connection_get_platform (ByxConnection *self)
{
	return nm_netns_get_platform (byx_connection_get_netns (self));
}

static NMConnectivity *
concheck_get_mgr (ByxConnection *self)
{
...
static NMIP4Config *
_ip4_config_new (ByxConnection *self)
{
	return nm_ip4_config_new (byx_connection_get_multi_index (self),
	                          byx_connection_get_ip_ifindex (self));
}

static NMIP6Config *
_ip6_config_new (ByxConnection *self)
{
	return nm_ip6_config_new (byx_connection_get_multi_index (self),
	                          byx_connection_get_ip_ifindex (self));
}

static NMIPConfig *
_ip_config_new (ByxConnection *self, int addr_family)
{
...
static void
applied_config_init_new (AppliedConfig *config, ByxConnection *self, int addr_family)
{
...
NM_UTILS_LOOKUP_STR_DEFINE_STATIC (_sys_iface_state_to_str, ByxConnectionSysIfaceState,
	NM_UTILS_LOOKUP_DEFAULT_NM_ASSERT ("unknown"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL, "external"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_SYS_IFACE_STATE_ASSUME,   "assume"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_SYS_IFACE_STATE_MANAGED,  "managed"),
	NM_UTILS_LOOKUP_STR_ITEM (BYX_CONNECTION_SYS_IFACE_STATE_REMOVED,  "removed"),
);

ByxConnectionSysIfaceState
byx_connection_sys_iface_state_get (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL);

	return BYX_CONNECTION_GET_PRIVATE (self)->sys_iface_state;
}

gboolean
byx_connection_sys_iface_state_is_external (ByxConnection *self)
{
	return NM_IN_SET (byx_connection_sys_iface_state_get (self),
	                  BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL);
}

gboolean
byx_connection_sys_iface_state_is_external_or_assume (ByxConnection *self)
{
	return NM_IN_SET (byx_connection_sys_iface_state_get (self),
	                  BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL,
	                  BYX_CONNECTION_SYS_IFACE_STATE_ASSUME);
}

void
byx_connection_sys_iface_state_set (ByxConnection *self,
                               ByxConnectionSysIfaceState sys_iface_state)
{
	...
	g_return_if_fail (NM_IN_SET (sys_iface_state,
	                             BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL,
	                             BYX_CONNECTION_SYS_IFACE_STATE_ASSUME,
	                             BYX_CONNECTION_SYS_IFACE_STATE_MANAGED,
	                             BYX_CONNECTION_SYS_IFACE_STATE_REMOVED));
...
static void
_active_connection_set_state_flags_full (ByxConnection *self,
                                         NMActivationStateFlags flags,
                                         NMActivationStateFlags mask)
{
	NMActiveConnection *ac;

	ac = NM_ACTIVE_CONNECTION (byx_connection_get_act_request (self));
	if (ac)
		nm_active_connection_set_state_flags_full (ac, flags, mask);
}

static void
_active_connection_set_state_flags (ByxConnection *self,
                                    NMActivationStateFlags flags)
{
...
void
byx_connection_assume_state_get (ByxConnection *self,
...
static void
_assume_state_set (ByxConnection *self,
                   gboolean assume_state_guess_assume,
                   const char *assume_state_connection_uuid)
{
	ByxConnectionPrivate *priv;

	nm_assert (BYX_IS_CONNECTION (self));
...
void
byx_connection_assume_state_reset (ByxConnection *self)
{
	g_return_if_fail (BYX_IS_CONNECTION (self));
...
init_ip_config_dns_priority (ByxConnection *self, NMIPConfig *config)
{
	...
	value = nm_config_data_get_connection_default (NM_CONFIG_GET_DATA,
	                                               (nm_ip_config_get_addr_family (config) == AF_INET)
	                                                 ...
	                                                 : "ipv6.dns-priority",
	                                               self);
	priority = _byx_utils_ascii_str_to_int64 (value, 10, G_MININT, G_MAXINT, 0);
...
byx_connection_ipv4_sysctl_set (ByxConnection *self, const char *property, const char *value)
{
	...
	if (!byx_connection_get_ip_ifindex (self))
		return FALSE;
	...
	if (value) {
		...
		value_to_free = nm_platform_sysctl_get (platform,
		                                        NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET, buf, "default", property)));
		value_to_set = value_to_free;
	}

	return nm_platform_sysctl_set (platform,
	                               NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET, buf, byx_connection_get_ip_iface (self), property)),
	                               value_to_set);
}

static guint32
byx_connection_ipv4_sysctl_get_effective_uint32 (ByxConnection *self, const char *property, guint32 fallback)
{
	char buf[NM_UTILS_SYSCTL_IP_CONF_PATH_BUFSIZE];
	gint64 v, v_all;
	...
	v = nm_platform_sysctl_get_int_checked (byx_connection_get_platform (self),
	                                        NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET,
	                                                                                                  buf,
	...
	v_all = nm_platform_sysctl_get_int_checked (byx_connection_get_platform (self),
	                                            NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET,
	                                                                                                      buf,
	                                                                                                      "all",
	                                                                                                      property)),
...
gboolean
byx_connection_ipv6_sysctl_set (ByxConnection *self, const char *property, const char *value)
{
	char buf[NM_UTILS_SYSCTL_IP_CONF_PATH_BUFSIZE];
	...
	return nm_platform_sysctl_set (byx_connection_get_platform (self), NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, buf, byx_connection_get_ip_iface (self), property)), value);
}

static guint32
byx_connection_ipv6_sysctl_get_uint32 (ByxConnection *self, const char *property, guint32 fallback)
{
	char buf[NM_UTILS_SYSCTL_IP_CONF_PATH_BUFSIZE];
	...
	return nm_platform_sysctl_get_int_checked (byx_connection_get_platform (self),
	                                           NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, buf, byx_connection_get_ip_iface (self), property)),
	                                           10,
	                                           0,
	                                           G_MAXUINT32,
	                                           fallback);
...
static void
_add_capabilities (ByxConnection *self, ByxConnectionCapabilities capabilities)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static const char *
_get_stable_id (ByxConnection *self,
                ...
                NMUtilsStableType *out_stable_type)
{
	...
	if (G_UNLIKELY (!priv->current_stable_id)) {
		...
		stable_type = byx_utils_stable_id_parse (stable_id,
		                                        byx_connection_get_ip_iface (self),
		                                        NULL,
		                                        uuid,
		                                        &generated);
		...
		if (stable_type == NM_UTILS_STABLE_TYPE_UUID)
			...
			priv->current_stable_id = nm_str_realloc (byx_utils_stable_id_generated_complete (generated));
		else {
			nm_assert (stable_type == NM_UTILS_STABLE_TYPE_RANDOM);
			priv->current_stable_id = nm_str_realloc (byx_utils_stable_id_random ());
		}
		_LOGT (LOGD_DEVICE,
		       "stable-id: type=%d, \"%s\""
		       "%s%s%s",
...
static void
_set_ip_state (ByxConnection *self, int addr_family, IpState new_state)
{
	IpState *p;
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
const char *
byx_connection_get_udi (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->udi;
}

const char *
byx_connection_get_iface (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->iface;
}

gboolean
byx_connection_take_over_link (ByxConnection *self, int ifindex, char **old_name)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	const NMPlatformLink *plink;
	NMPlatform *platform;
	...
	platform = byx_connection_get_platform (self);
	...
	if (!nm_streq (plink->name, byx_connection_get_iface (self))) {
		...
		success = nm_platform_link_set_name (platform, ifindex, byx_connection_get_iface (self));
		if (up)
...
int
byx_connection_get_ifindex (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), 0);

	return BYX_CONNECTION_GET_PRIVATE (self)->ifindex;
}

/**
 * byx_connection_is_software:
...
/**
 * byx_connection_is_real:
 * @self: the #ByxConnection
 *
 * Returns: %TRUE if the device exists, %FALSE if the device is a placeholder
 */
gboolean
byx_connection_is_real (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);

	return BYX_CONNECTION_GET_PRIVATE (self)->real;
}

const char *
byx_connection_get_ip_iface (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
int
byx_connection_get_ip_ifindex (const ByxConnection *self)
{
	const ByxConnectionPrivate *priv;
...
static void
_set_ip_ifindex (ByxConnection *self,
                 int ifindex,
                 const char *ifname)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
gboolean
byx_connection_set_ip_ifindex (ByxConnection *self, int ifindex)
{
	char ifname_buf[IFNAMSIZ];
	const char *ifname = NULL;

	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);
	g_return_val_if_fail (byx_connection_is_activating (self), FALSE);

	if (ifindex > 0) {
		ifname = nm_platform_if_indextoname (byx_connection_get_platform (self), ifindex, ifname_buf);
		if (!ifname)
 ...
 */
gboolean
byx_connection_set_ip_iface (ByxConnection *self, const char *ifname)
{
	int ifindex = 0;
	...
	if (ifname) {
		ifindex = nm_platform_if_nametoindex (byx_connection_get_platform (self), ifname);
		if (ifindex <= 0)
...
static gboolean
_ip_iface_update (ByxConnection *self, const char *ip_iface)
{
	ByxConnectionPrivate *priv;
...
int
byx_connection_parent_get_ifindex (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
ByxConnection *
byx_connection_parent_get_device (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->parent_device.obj;
}

static void
parent_changed_notify (ByxConnection *self,
                       int old_ifindex,
...
static gboolean
_parent_set_ifindex (ByxConnection *self,
                     int parent_ifindex,
                     gboolean force_check)
{
	ByxConnectionPrivate *priv;
	ByxConnection *parent_device;
	gboolean changed = FALSE;
	int old_ifindex;
	gs_unref_object ByxConnection *old_device = NULL;
	...
	if (priv->parent_ifindex == parent_ifindex) {
		if (parent_ifindex > 0) {
			if (   !force_check
			    ...
			    && byx_connection_get_ifindex (priv->parent_device.obj) == parent_ifindex)
				return FALSE;
		} else {
	...
	if (parent_ifindex > 0) {
		parent_device = byx_manager_get_device_by_ifindex (byx_manager_get (), parent_ifindex);
	...
	if (changed) {
		if (priv->parent_ifindex <= 0)
			...
			_LOGD (LOGD_DEVICE, "parent: ifindex %d, device %p, %s", priv->parent_ifindex,
			       priv->parent_device.obj, byx_connection_get_iface (priv->parent_device.obj));
		}

		BYX_CONNECTION_GET_CLASS (self)->parent_changed_notify (self, old_ifindex, old_device, priv->parent_ifindex, priv->parent_device.obj);
	}
	return changed;
}

void
byx_connection_parent_set_ifindex (ByxConnection *self,
                              int parent_ifindex)
{
...
gboolean
byx_connection_parent_notify_changed (ByxConnection *self,
                                 ...
                                 gboolean device_removed)
{
	...
	nm_assert (BYX_IS_CONNECTION (self));
	nm_assert (BYX_IS_CONNECTION (change_candidate));

	priv = BYX_CONNECTION_GET_PRIVATE (self);

	if (priv->parent_ifindex > 0) {
		if (   priv->parent_device.obj == change_candidate
		    || priv->parent_ifindex == byx_connection_get_ifindex (change_candidate))
...
static void
_stats_update_counters (ByxConnection *self,
                        guint64 tx_bytes,
                        guint64 rx_bytes)
{
	ByxConnectionPrivate *priv;
...
static void
_stats_update_counters_from_pllink (ByxConnection *self, const NMPlatformLink *pllink)
{
...
_stats_timeout_cb (gpointer user_data)
{
	...
	if (ifindex > 0)
		nm_platform_link_refresh (byx_connection_get_platform (self), ifindex);
...
static void
_stats_set_refresh_rate (ByxConnection *self, guint refresh_rate_ms)
{
	ByxConnectionPrivate *priv;
	int ifindex;
	guint old_rate;
...
static gboolean
get_ip_iface_identifier (ByxConnection *self, NMUtilsIPv6IfaceId *out_iid)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMPlatform *platform = byx_connection_get_platform (self);
	...
	success = byx_utils_get_ipv6_interface_identifier (pllink->type,
	                                                  hwaddr,
	                                                  hwaddr_len,
	                                                  priv->dev_id,
	                                                  out_iid);
...
/**
 * byx_connection_get_ip_iface_identifier:
 * @self: an #ByxConnection
 ...
 */
static gboolean
byx_connection_get_ip_iface_identifier (ByxConnection *self, NMUtilsIPv6IfaceId *iid, gboolean ignore_token)
{
	...
	if (!ignore_token) {
		s_ip6 = (NMSettingIP6Config *)
		    byx_connection_get_applied_setting (self, NM_TYPE_SETTING_IP6_CONFIG);
		g_return_val_if_fail (s_ip6, FALSE);
		token = nm_setting_ip6_config_get_token (s_ip6);
	}
	if (token)
		return byx_utils_ipv6_interface_identifier_get_from_token (iid, token);
	else
		return BYX_CONNECTION_GET_CLASS (self)->get_ip_iface_identifier (self, iid);
}

const char *
byx_connection_get_driver (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->driver;
}

const char *
byx_connection_get_driver_version (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->driver_version;
}

ByxConnectionType
byx_connection_get_device_type (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), BYX_CONNECTION_TYPE_UNKNOWN);

	return BYX_CONNECTION_GET_PRIVATE (self)->type;
}

NMLinkType
byx_connection_get_link_type (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NM_LINK_TYPE_UNKNOWN);

	return BYX_CONNECTION_GET_PRIVATE (self)->link_type;
}

/**
 * byx_connection_get_metered:
 * @setting: the #ByxConnection
 *
 * Returns: the #ByxConnection:metered property of the device.
 *
 * Since: 1.2
 **/
NMMetered
byx_connection_get_metered (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NM_METERED_UNKNOWN);

	return BYX_CONNECTION_GET_PRIVATE (self)->metered;
}

guint32
byx_connection_get_route_metric_default (ByxConnectionType device_type)
{
	...
	case BYX_CONNECTION_TYPE_ETHERNET:
	case BYX_CONNECTION_TYPE_VETH:
		return 100;
	case BYX_CONNECTION_TYPE_MACSEC:
		return 125;
	case BYX_CONNECTION_TYPE_INFINIBAND:
		return 150;
	case BYX_CONNECTION_TYPE_ADSL:
		return 200;
	case BYX_CONNECTION_TYPE_WIMAX:
		return 250;
	case BYX_CONNECTION_TYPE_BOND:
		return 300;
	case BYX_CONNECTION_TYPE_TEAM:
		return 350;
	case BYX_CONNECTION_TYPE_VLAN:
		return 400;
	case BYX_CONNECTION_TYPE_MACVLAN:
		return 410;
	case BYX_CONNECTION_TYPE_BRIDGE:
		return 425;
	case BYX_CONNECTION_TYPE_TUN:
		return 450;
	case BYX_CONNECTION_TYPE_PPP:
		return 460;
	case BYX_CONNECTION_TYPE_VXLAN:
		return 500;
	case BYX_CONNECTION_TYPE_DUMMY:
		return 550;
	case BYX_CONNECTION_TYPE_WIFI:
		return 600;
	case BYX_CONNECTION_TYPE_OLPC_MESH:
		return 650;
	case BYX_CONNECTION_TYPE_IP_TUNNEL:
		return 675;
	case BYX_CONNECTION_TYPE_MODEM:
		return 700;
	case BYX_CONNECTION_TYPE_BT:
		return 750;
	case BYX_CONNECTION_TYPE_6LOWPAN:
		return 775;
	case BYX_CONNECTION_TYPE_OVS_BRIDGE:
	case BYX_CONNECTION_TYPE_OVS_INTERFACE:
	case BYX_CONNECTION_TYPE_OVS_PORT:
		return 800;
	case BYX_CONNECTION_TYPE_WPAN:
		return 850;
	case BYX_CONNECTION_TYPE_GENERIC:
		return 950;
	case BYX_CONNECTION_TYPE_UNKNOWN:
		return 10000;
	case BYX_CONNECTION_TYPE_UNUSED1:
	case BYX_CONNECTION_TYPE_UNUSED2:
...
static gboolean
default_route_metric_penalty_detect (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static guint32
default_route_metric_penalty_get (ByxConnection *self, int addr_family)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
guint32
byx_connection_get_route_metric (ByxConnection *self,
                            int addr_family)
{
	char *value;
	gint64 route_metric;
	...
	g_return_val_if_fail (BYX_IS_CONNECTION (self), G_MAXUINT32);
	...
	route_metric = byx_manager_device_route_metric_reserve (byx_manager_get (),
	                                                       byx_connection_get_ip_ifindex (self),
	                                                       byx_connection_get_device_type (self));
out:
	return byx_utils_ip_route_metric_normalize (addr_family, route_metric);
}

static NMSettingConnectionMdns
_get_mdns (ByxConnection *self)
{
	NMConnection *connection;
	NMSettingConnectionMdns mdns = NM_SETTING_CONNECTION_MDNS_DEFAULT;

	g_return_val_if_fail (BYX_IS_CONNECTION (self), NM_SETTING_CONNECTION_MDNS_DEFAULT);
...
guint32
byx_connection_get_route_table (ByxConnection *self,
                           int addr_family,
                           gboolean fallback_main)
{
	...
	g_return_val_if_fail (BYX_IS_CONNECTION (self), RT_TABLE_MAIN);
		...
		if (route_table == 0) {
			...
			value = nm_config_data_get_connection_default (NM_CONFIG_GET_DATA,
			                                               addr_family == AF_INET
			                                                 ...
			                                                 : "ipv6.route-table",
			                                               self);
			route_table = _byx_utils_ascii_str_to_int64 (value, 10, 0, G_MAXUINT32, 0);
		}
	}
...
const NMPObject *
byx_connection_get_best_default_route (ByxConnection *self,
                                  int addr_family)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
const char *
byx_connection_get_type_desc (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->type_desc;
}

const char *
byx_connection_get_type_description (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, NULL);

	/* Beware: this function should return the same
	 * value as byx_connection_get_type_description() in libnm. */

	return BYX_CONNECTION_GET_CLASS (self)->get_type_description (self);
}

static const char *
get_type_description (ByxConnection *self)
{
	 ...
	 * of the parent class. That means, if ByxConnectionVethClass was initialized after
	 * ByxConnectionEthernetClass already has the description cached in the class
...
gboolean
byx_connection_has_carrier (ByxConnection *self)
{
	return BYX_CONNECTION_GET_PRIVATE (self)->carrier;
}

NMActRequest *
byx_connection_get_act_request (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->act_request.obj;
}

NMSettingsConnection *
byx_connection_get_settings_connection (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
NMConnection *
byx_connection_get_applied_connection (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
gboolean
byx_connection_has_unmodified_applied_connection (ByxConnection *self, NMSettingCompareFlags compare_flags)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
NMSetting *
byx_connection_get_applied_setting (ByxConnection *self, GType setting_type)
{
	NMConnection *connection;
...
RfKillType
byx_connection_get_rfkill_type (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);

	return BYX_CONNECTION_GET_PRIVATE (self)->rfkill_type;
}

static const char *
byx_connection_get_physical_port_id (ByxConnection *self)
{
	return BYX_CONNECTION_GET_PRIVATE (self)->physical_port_id;
}
...
static ByxConnectionConnectivityHandle *concheck_start (ByxConnection *self,
                                                   ByxConnectionConnectivityCallback callback,
                                                   gpointer user_data,
                                                   gboolean is_periodic);

static void concheck_periodic_schedule_set (ByxConnection *self,
...
static gboolean
concheck_is_possible (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (priv->state == BYX_CONNECTION_STATE_UNKNOWN)
		return FALSE;
...
static gboolean
concheck_periodic_schedule_do (ByxConnection *self, gint64 now_ns)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
concheck_periodic_schedule_set (ByxConnection *self,
                                ConcheckScheduleMode mode)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	case CONCHECK_SCHEDULE_UPDATE_INTERVAL_RESTART:
		...
		priv->concheck_p_cur_basetime_ns = byx_utils_get_monotonic_timestamp_ns_cached (&now_ns);
	...
	case CONCHECK_SCHEDULE_UPDATE_INTERVAL:
		...
		byx_utils_get_monotonic_timestamp_ns_cached (&now_ns);
	...
	tdiff = NM_MAX (new_expiry - byx_utils_get_monotonic_timestamp_ns_cached (&now_ns), 0);
	priv->concheck_p_cur_basetime_ns = now_ns + tdiff - (priv->concheck_p_cur_interval * NM_UTILS_NS_PER_SECOND);
	concheck_periodic_schedule_do (self, now_ns);
}

static void
concheck_update_interval (ByxConnection *self, gboolean check_now)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	guint new_interval;
...
void
byx_connection_check_connectivity_update_interval (ByxConnection *self)
{
	concheck_update_interval (self, FALSE);
}

static void
concheck_update_state (ByxConnection *self, NMConnectivityState state, gboolean allow_periodic_bump)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (state == NM_CONNECTIVITY_ERROR) {
		...
		if (priv->state == BYX_CONNECTION_STATE_ACTIVATED) {
			 ...
			 * was activated. */
			if (byx_connection_get_best_default_route (self, AF_UNSPEC))
	 ...
	 * a signal might call back into ByxConnection and change the probe settings.
	 * So, do that first. */
	...
	if (   priv->state == BYX_CONNECTION_STATE_ACTIVATED
	    && !byx_connection_sys_iface_state_is_external (self)) {
		if (   byx_connection_get_best_default_route (self, AF_INET)
		    && !ip_config_merge_and_apply (self, AF_INET, TRUE))
			_LOGW (LOGD_IP4, "Failed to update IPv4 route metric");
		if (   byx_connection_get_best_default_route (self, AF_INET6)
...
static void
concheck_handle_complete (ByxConnectionConnectivityHandle *handle,
                          GError *error)
{
	...
	if (handle->callback) {
		handle->callback (handle->self,
		                  handle,
		                  BYX_CONNECTION_GET_PRIVATE (handle->self)->connectivity_state,
		                  error,
		                  handle->user_data);
	}

	g_slice_free (ByxConnectionConnectivityHandle, handle);
}
...
concheck_cb (NMConnectivity *connectivity,
             ...
             gpointer user_data)
{
	_nm_unused gs_unref_object ByxConnection *self_keep_alive = NULL;
	ByxConnection *self;
	ByxConnectionPrivate *priv;
	ByxConnectionConnectivityHandle *handle;
	ByxConnectionConnectivityHandle *other_handle;
	...
	nm_assert (BYX_IS_CONNECTION (handle->self));

	handle->c_handle = NULL;
	self = handle->self;

	if (byx_utils_error_is_cancelled (error, FALSE)) {
	...
	nm_assert (!byx_utils_error_is_cancelled (error, TRUE));
...
static ByxConnectionConnectivityHandle *
concheck_start (ByxConnection *self,
                ByxConnectionConnectivityCallback callback,
                gpointer user_data,
                gboolean is_periodic)
{
	...
	handle = g_slice_new0 (ByxConnectionConnectivityHandle);
...
ByxConnectionConnectivityHandle *
byx_connection_check_connectivity (ByxConnection *self,
                              ByxConnectionConnectivityCallback callback,
                              gpointer user_data)
{
	ByxConnectionConnectivityHandle *handle;
...
byx_connection_check_connectivity_cancel (ByxConnectionConnectivityHandle *handle)
{
	...
	byx_utils_error_set_cancelled (&cancelled_error, FALSE, "ByxConnection");
	concheck_handle_complete (handle, cancelled_error);
}

NMConnectivityState
byx_connection_get_connectivity_state (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NM_CONNECTIVITY_UNKNOWN);

	return BYX_CONNECTION_GET_PRIVATE (self)->connectivity_state;
}

/*****************************************************************************/

static SlaveInfo *
find_slave_info (ByxConnection *self, ByxConnection *slave)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	CList *iter;
	SlaveInfo *info;
...
/**
 * byx_connection_master_enslave_slave:
 ...
 */
static gboolean
byx_connection_master_enslave_slave (ByxConnection *self, ByxConnection *slave, NMConnection *connection)
{
	SlaveInfo *info;
	...
	g_return_val_if_fail (BYX_CONNECTION_GET_CLASS (self)->enslave_slave != NULL, FALSE);
	...
	if (info->slave_is_enslaved)
		...
		if (configure)
			g_return_val_if_fail (byx_connection_get_state (slave) >= BYX_CONNECTION_STATE_DISCONNECTED, FALSE);

		success = BYX_CONNECTION_GET_CLASS (self)->enslave_slave (self, slave, connection, configure);
		info->slave_is_enslaved = success;
	}

	byx_connection_slave_notify_enslave (info->slave, success);

	/* Ensure the device's hardware address is up-to-date; it often changes
	 * when slaves change.
	 */
	byx_connection_update_hw_address (self);
	 ...
	 */
	if (success) {
		if (BYX_CONNECTION_GET_PRIVATE (self)->ip4_state == IP_WAIT)
			byx_connection_activate_stage3_ip4_start (self);

		if (BYX_CONNECTION_GET_PRIVATE (self)->ip6_state == IP_WAIT)
	 ...
	 * set the MTU here.
	 */
	_commit_mtu (slave, BYX_CONNECTION_GET_PRIVATE (slave)->ip_config_4);

	return success;
}

/**
 * byx_connection_master_release_one_slave:
 * @self: the master device
 ...
 */
static void
byx_connection_master_release_one_slave (ByxConnection *self, ByxConnection *slave, gboolean configure, ByxConnectionStateReason reason)
{
	ByxConnectionPrivate *priv;
	ByxConnectionPrivate *slave_priv;
	SlaveInfo *info;
	gs_unref_object ByxConnection *self_free = NULL;

	g_return_if_fail (BYX_CONNECTION (self));
	g_return_if_fail (BYX_CONNECTION (slave));
	g_return_if_fail (BYX_CONNECTION_GET_CLASS (self)->release_slave != NULL);

	info = find_slave_info (self, slave);

	_LOGT (LOGD_CORE, "master: release one slave %p/%s%s", slave, byx_connection_get_iface (slave),
	       !info ? " (not registered)" : "");
	...
	priv = BYX_CONNECTION_GET_PRIVATE (self);
	slave_priv = BYX_CONNECTION_GET_PRIVATE (slave);
	...
	if (info->slave_is_enslaved)
		BYX_CONNECTION_GET_CLASS (self)->release_slave (self, slave, configure);

	/* raise notifications about the release, including clearing is_enslaved. */
	byx_connection_slave_notify_release (slave, reason);
	 ...
	 */
	byx_connection_update_hw_address (self);
	byx_connection_set_unmanaged_by_flags (slave, NM_UNMANAGED_IS_SLAVE, NM_UNMAN_FLAG_OP_FORGET, BYX_CONNECTION_STATE_REASON_REMOVED);
}
 ...
 */
static gboolean
can_unmanaged_external_down (ByxConnection *self)
{
	return    !BYX_CONNECTION_GET_PRIVATE (self)->nm_owned
	       && byx_connection_is_software (self);
}

static NMUnmanFlagOp
is_unmanaged_external_down (ByxConnection *self, gboolean consider_can)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);

	if (   consider_can
	    && !BYX_CONNECTION_GET_CLASS (self)->can_unmanaged_external_down (self))
	...
	if (   priv->ifindex <= 0
	    ...
	    || !(   !c_list_is_empty (&priv->slaves)
	         || nm_platform_link_can_assume (byx_connection_get_platform (self), priv->ifindex)))
...
static void
set_unmanaged_external_down (ByxConnection *self, gboolean only_if_unmanaged)
{
	NMUnmanFlagOp ext_flags;

	if (!byx_connection_get_unmanaged_mask (self, NM_UNMANAGED_EXTERNAL_DOWN))
		return;

	if (only_if_unmanaged) {
		if (!byx_connection_get_unmanaged_flags (self, NM_UNMANAGED_EXTERNAL_DOWN))
			return;
	}
	...
	if (ext_flags != NM_UNMAN_FLAG_OP_SET_UNMANAGED) {
		 ...
		 */
		byx_connection_queue_recheck_assume (self);
	}

	byx_connection_set_unmanaged_by_flags (self,
	                                  NM_UNMANAGED_EXTERNAL_DOWN,
	                                  ext_flags,
	                                  BYX_CONNECTION_STATE_REASON_CONNECTION_ASSUMED);
}

void
byx_connection_update_dynamic_ip_setup (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
	GError *error = NULL;
	...
	if (priv->dhcp4.client) {
		if (!byx_connection_dhcp4_renew (self, FALSE)) {
			byx_connection_state_changed (self,
			                         BYX_CONNECTION_STATE_FAILED,
			                         BYX_CONNECTION_STATE_REASON_DHCP_FAILED);
			return;
		}
	}
	if (priv->dhcp6.client) {
		if (!byx_connection_dhcp6_renew (self, FALSE)) {
			byx_connection_state_changed (self,
			                         BYX_CONNECTION_STATE_FAILED,
			                         BYX_CONNECTION_STATE_REASON_DHCP_FAILED);
			return;
	...
	if (priv->lldp_listener && nm_lldp_listener_is_running (priv->lldp_listener)) {
		...
		if (!nm_lldp_listener_start (priv->lldp_listener, byx_connection_get_ifindex (self), &error)) {
...
static void
carrier_changed_notify (ByxConnection *self, gboolean carrier)
{
	/* stub */
}

static void
carrier_changed (ByxConnection *self, gboolean carrier)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);

	if (priv->state <= BYX_CONNECTION_STATE_UNMANAGED)
		return;

	byx_connection_recheck_available_connections (self);

	/* ignore-carrier devices ignore all carrier-down events */
	if (priv->ignore_carrier && !carrier)
		return;

	if (byx_connection_is_master (self)) {
		if (carrier) {
			...
			* is restored. */
			 ...
			 * waiting for carrier. */
			if (byx_connection_activate_ip4_state_in_wait (self))
				byx_connection_activate_stage3_ip4_start (self);
			if (byx_connection_activate_ip6_state_in_wait (self))
				byx_connection_activate_stage3_ip6_start (self);
			return;
		}
	...
	if (carrier) {
		if (priv->state == BYX_CONNECTION_STATE_UNAVAILABLE) {
			byx_connection_queue_state (self, BYX_CONNECTION_STATE_DISCONNECTED,
			                       BYX_CONNECTION_STATE_REASON_CARRIER);
		} else if (priv->state == BYX_CONNECTION_STATE_DISCONNECTED) {
			 ...
			 * the device.
			 */
			byx_connection_emit_recheck_auto_activate (self);
		} else if (priv->state == BYX_CONNECTION_STATE_ACTIVATED) {
		...
		if (priv->state == BYX_CONNECTION_STATE_UNAVAILABLE) {
			if (   priv->queued_state.id
			    && priv->queued_state.state >= BYX_CONNECTION_STATE_DISCONNECTED)
				queued_state_clear (self);
		} else {
			byx_connection_queue_state (self, BYX_CONNECTION_STATE_UNAVAILABLE,
			                       BYX_CONNECTION_STATE_REASON_CARRIER);
		}
	}
}
...
{
	ByxConnection *self = BYX_CONNECTION (user_data);
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
carrier_disconnected_action_cancel (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
void
byx_connection_set_carrier (ByxConnection *self, gboolean carrier)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	ByxConnectionState state = byx_connection_get_state (self);
	...
	if (priv->carrier) {
		...
		BYX_CONNECTION_GET_CLASS (self)->carrier_changed_notify (self, carrier);
		carrier_changed (self, TRUE);

		if (priv->carrier_wait_id) {
			byx_connection_remove_pending_action (self, NM_PENDING_ACTION_CARRIER_WAIT, FALSE);
			_carrier_wait_check_queued_act_request (self);
		}
	} else {
		if (priv->carrier_wait_id)
			byx_connection_add_pending_action (self, NM_PENDING_ACTION_CARRIER_WAIT, FALSE);
		BYX_CONNECTION_GET_CLASS (self)->carrier_changed_notify (self, carrier);
...
static void
byx_connection_set_carrier_from_platform (ByxConnection *self)
{
	if (byx_connection_has_capability (self, BYX_CONNECTION_CAP_CARRIER_DETECT)) {
		if (!byx_connection_has_capability (self, BYX_CONNECTION_CAP_NONSTANDARD_CARRIER)) {
			byx_connection_set_carrier (self,
			                       nm_platform_link_is_connected (byx_connection_get_platform (self),
			                                                      byx_connection_get_ip_ifindex (self)));
		}
	} else {
		ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
device_recheck_slave_status (ByxConnection *self, const NMPlatformLink *plink)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	ByxConnection *master;
	...
	master = byx_manager_get_device_by_ifindex (byx_manager_get (), plink->master);
	plink_master = nm_platform_link_get (byx_connection_get_platform (self), plink->master);
	...
	if (priv->master) {
		if (   plink->master > 0
		    && plink->master == byx_connection_get_ifindex (priv->master)) {
			/* call add-slave again. We expect @self already to be added to
			 * the master, but this also triggers a recheck-assume. */
			byx_connection_master_add_slave (priv->master, self, FALSE);
			return;
		}

		byx_connection_master_release_one_slave (priv->master, self, FALSE, BYX_CONNECTION_STATE_REASON_CONNECTION_ASSUMED);
	}

	if (master && BYX_CONNECTION_GET_CLASS (master)->enslave_slave)
		byx_connection_master_add_slave (master, self, FALSE);
	else if (master) {
		_LOGI (LOGD_DEVICE, "enslaved to non-master-type device %s; ignoring",
		       byx_connection_get_iface (master));
	} else {
...
static void
ndisc_set_router_config (NMNDisc *ndisc, ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	gint32 now;
	...
	nm_dedup_multi_iter_for_each (&ipconf_iter, head_entry) {
		...
		lifetime = byx_utils_lifetime_get (addr->timestamp, addr->lifetime, addr->preferred,
		                                  base, &preferred);
		if (!lifetime)
			continue;
...
static gboolean
device_link_changed (ByxConnection *self)
{
	...
	ifindex = byx_connection_get_ifindex (self);
	pllink = nm_platform_link_get (byx_connection_get_platform (self), ifindex);
	if (!pllink)
		return G_SOURCE_REMOVE;

	pllink_keep_alive = nmp_object_ref (NMP_OBJECT_UP_CAST (pllink));

	byx_connection_update_from_platform_link (self, pllink);
	...
	if (pllink->name[0] && strcmp (priv->iface, pllink->name) != 0) {
		...
		if (byx_connection_get_unmanaged_flags (self, NM_UNMANAGED_PLATFORM_INIT))
			byx_connection_set_unmanaged_by_user_settings (self);
		else
	...
	if (   byx_connection_has_capability (self, BYX_CONNECTION_CAP_CARRIER_DETECT)
	    && !byx_connection_has_capability (self, BYX_CONNECTION_CAP_NONSTANDARD_CARRIER))
		byx_connection_set_carrier (self, pllink->connected);
	...
	if (   pllink->initialized
		...
		byx_connection_set_unmanaged_by_user_udev (self);
		byx_connection_set_unmanaged_by_user_conf (self);

		reason = BYX_CONNECTION_STATE_REASON_NOW_MANAGED;
		 ...
		 * "assumed". */
		if (    byx_connection_get_unmanaged_mask (self, NM_UNMANAGED_EXTERNAL_DOWN)
		    && !byx_connection_get_unmanaged_flags (self, NM_UNMANAGED_EXTERNAL_DOWN)) {
			...
			if (!byx_connection_get_unmanaged_mask (self, NM_UNMANAGED_USER_UDEV)) {
				/* Ensure the assume check is queued before any queued state changes
				 * from the transition to UNAVAILABLE.
				 */
				byx_connection_queue_recheck_assume (self);
				reason = BYX_CONNECTION_STATE_REASON_CONNECTION_ASSUMED;
			}
		}

		byx_connection_set_unmanaged_by_flags (self, NM_UNMANAGED_PLATFORM_INIT, FALSE, reason);
	}
	...
	if (   got_hw_addr
	    && !priv->up
	    && byx_connection_get_state (self) == BYX_CONNECTION_STATE_UNAVAILABLE) {
		/*
		 ...
		 */
		byx_connection_bring_up (self, TRUE, NULL);
		byx_connection_queue_recheck_available (self,
		                                   BYX_CONNECTION_STATE_REASON_NONE,
		                                   BYX_CONNECTION_STATE_REASON_NONE);
	}
...
static gboolean
device_ip_link_changed (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	const NMPlatformLink *pllink;
	...
	pllink = nm_platform_link_get (byx_connection_get_platform (self), priv->ip_ifindex);
	if (!pllink)
		return G_SOURCE_REMOVE;
                 ...
                 ByxConnection *self)
{
	...
	if (ifindex == byx_connection_get_ifindex (self)) {
	...
	} else if (ifindex == byx_connection_get_ip_ifindex (self)) {
...
static gboolean
_v4_has_shadowed_routes_detect (ByxConnection *self)
{
	NMPlatform *platform;
	int ifindex;
	NMPLookup lookup;
	...
	nmp_cache_iter_for_each (&iter, head_entry, &o) {
		...
		d = &data_arr[data_len++];
		d->network = byx_utils_ip4_address_clear_host_address (r->network, r->plen);
		d->plen = r->plen;
...
static void
ip4_rp_filter_update (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	const char *ip4_rp_filter;

	if (   priv->v4_has_shadowed_routes
	    || byx_connection_get_best_default_route (self, AF_INET)) {
		if (byx_connection_ipv4_sysctl_get_effective_uint32 (self, "rp_filter", 0) != 1) {
	...
	if (ip4_rp_filter != priv->ip4_rp_filter) {
		byx_connection_ipv4_sysctl_set (self, "rp_filter", ip4_rp_filter);
		priv->ip4_rp_filter = ip4_rp_filter;
	}
}

static void
link_changed (ByxConnection *self, const NMPlatformLink *pllink)
{
	/* stub implementation of virtual function to allow subclasses to chain up. */
}

static gboolean
link_type_compatible (ByxConnection *self,
                      NMLinkType link_type,
                      ...
                      GError **error)
{
	...
	if (device_type > NM_LINK_TYPE_UNKNOWN && device_type != link_type) {
		g_set_error (error, BYX_CONNECTION_ERROR, BYX_CONNECTION_ERROR_FAILED,
 ...
 * the device is ready for use byx_connection_realize_finish() must be called.
 * @out_compatible will only be set if @plink is not %NULL, and
 *
 * Important: if byx_connection_realize_start() returns %TRUE, the caller MUST
 * also call byx_connection_realize_finish() to balance g_object_freeze_notify().
 *
 * Returns: %TRUE on success, %FALSE on error
 */
gboolean
byx_connection_realize_start (ByxConnection *self,
                         const NMPlatformLink *plink,
                         gboolean assume_state_guess_assume,
                         const char *assume_state_connection_uuid,
                         gboolean set_nm_owned,
                         ...
                         GError **error)
{
	...
	if (plink) {
		if (g_strcmp0 (byx_connection_get_iface (self), plink->name) != 0) {
			NM_SET_OUT (out_compatible, FALSE);
			g_set_error_literal (error, BYX_CONNECTION_ERROR, BYX_CONNECTION_ERROR_FAILED,
...
/**
 * byx_connection_create_and_realize():
 * @self: the #ByxConnection
 ...
 */
gboolean
byx_connection_create_and_realize (ByxConnection *self,
                              NMConnection *connection,
                              ...
                              GError **error)
{
	...
	priv->nm_owned = !nm_platform_link_get_by_ifname (byx_connection_get_platform (self), priv->iface);

	_LOGD (LOGD_DEVICE, "create (is %snm-owned)", priv->nm_owned ? "" : "not ");

	/* Create any resources the device needs */
	if (BYX_CONNECTION_GET_CLASS (self)->create_and_realize) {
		if (!BYX_CONNECTION_GET_CLASS (self)->create_and_realize (self, connection, parent, &plink, error))
			return FALSE;
		if (plink) {
	...
	byx_connection_realize_finish (self, plink);

	if (byx_connection_get_managed (self, FALSE)) {
		byx_connection_state_changed (self,
		                         BYX_CONNECTION_STATE_UNAVAILABLE,
		                         BYX_CONNECTION_STATE_REASON_NOW_MANAGED);
	}
	return TRUE;
}

void
byx_connection_update_from_platform_link (ByxConnection *self, const NMPlatformLink *plink)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	const char *str;
	int ifindex;
	...
	str = plink ? nm_platform_link_get_udi (byx_connection_get_platform (self), plink->ifindex) : NULL;
	...
	if (priv->ifindex != ifindex) {
		priv->ifindex = ifindex;
		_notify (self, PROP_IFINDEX);
		BYX_CONNECTION_GET_CLASS (self)->link_changed (self, plink);
	}
}
...
device_init_sriov_num_vfs (ByxConnection *self)
{
	...
	if (   priv->ifindex > 0
		...
		if (num_vfs >= 0) {
			nm_platform_link_set_sriov_num_vfs (byx_connection_get_platform (self),
                      ...
                      const NMPlatformLink *pllink)
{
	...
	BYX_CONNECTION_GET_CLASS (self)->link_changed (self, pllink);
}
 ...
 */
static void
realize_start_setup (ByxConnection *self,
                     const NMPlatformLink *plink,
                     gboolean assume_state_guess_assume,
                     const char *assume_state_connection_uuid,
                     gboolean set_nm_owned,
                     NMUnmanFlagOp unmanaged_user_explicit)
{
	...
	g_return_if_fail (byx_connection_get_unmanaged_flags (self, NM_UNMANAGED_PLATFORM_INIT));
	...
	/* Balanced by a thaw in byx_connection_realize_finish() */
	g_object_freeze_notify (G_OBJECT (self));

	priv->mtu_source = BYX_CONNECTION_MTU_SOURCE_NONE;
	priv->mtu_initial = 0;
	...
	byx_connection_sys_iface_state_set (self, BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL);

	if (plink)
		byx_connection_update_from_platform_link (self, plink);

	if (priv->ifindex > 0) {
		priv->physical_port_id = nm_platform_link_get_physical_port_id (byx_connection_get_platform (self), priv->ifindex);
		_notify (self, PROP_PHYSICAL_PORT_ID);

		priv->dev_id = nm_platform_link_get_dev_id (byx_connection_get_platform (self), priv->ifindex);

		if (nm_platform_link_is_software (byx_connection_get_platform (self), priv->ifindex))
			capabilities |= BYX_CONNECTION_CAP_IS_SOFTWARE;

		_set_mtu (self,
		          nm_platform_link_get_mtu (byx_connection_get_platform (self),
		                                    priv->ifindex));

		nm_platform_link_get_driver_info (byx_connection_get_platform (self),
		                                  priv->ifindex,
		                                  NULL,
		                                  &priv->driver_version,
		...
		if (nm_platform_check_kernel_support (byx_connection_get_platform (self),
		                                      NM_PLATFORM_KERNEL_SUPPORT_USER_IPV6LL))
			priv->ipv6ll_handle = nm_platform_link_get_user_ipv6ll_enabled (byx_connection_get_platform (self), priv->ifindex);

		if (nm_platform_link_supports_sriov (byx_connection_get_platform (self), priv->ifindex))
			capabilities |= BYX_CONNECTION_CAP_SRIOV;
	}
	...
	byx_connection_update_hw_address (self);
	byx_connection_update_initial_hw_address (self);
	byx_connection_update_permanent_hw_address (self, FALSE);
	...
	nm_assert (!byx_connection_get_unmanaged_mask (self, NM_UNMANAGED_USER_EXPLICIT));
	byx_connection_set_unmanaged_flags (self,
	...
	byx_connection_set_unmanaged_flags (self, NM_UNMANAGED_LOOPBACK, priv->ifindex == 1);

	byx_connection_set_unmanaged_by_user_udev (self);
	byx_connection_set_unmanaged_by_user_conf (self);

	byx_connection_set_unmanaged_flags (self, NM_UNMANAGED_PLATFORM_INIT,
	                               plink && !plink->initialized);
}

/**
 * byx_connection_realize_finish():
 * @self: the #ByxConnection
 * @plink: the #NMPlatformLink if backed by a kernel netdevice
 *
 ...
 */
void
byx_connection_realize_finish (ByxConnection *self, const NMPlatformLink *plink)
{
	ByxConnectionPrivate *priv;
...
static void
unrealize_notify (ByxConnection *self)
{
...
available_connections_check_delete_unrealized_on_idle (gpointer user_data)
{
	...
	g_return_val_if_fail (BYX_IS_CONNECTION (self), G_SOURCE_REMOVE);
...
static void
available_connections_check_delete_unrealized (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
 ...
 */
gboolean
byx_connection_unrealize (ByxConnection *self, gboolean remove_resources, GError **error)
{
	ByxConnectionPrivate *priv;
	int ifindex;
	...
	if (!byx_connection_is_software (self) || !byx_connection_is_real (self)) {
		g_set_error_literal (error,
		                     BYX_CONNECTION_ERROR,
		                     BYX_CONNECTION_ERROR_NOT_SOFTWARE,
	...
	byx_connection_assume_state_reset (self);

	if (remove_resources) {
		if (BYX_CONNECTION_GET_CLASS (self)->unrealize) {
			if (!BYX_CONNECTION_GET_CLASS (self)->unrealize (self, error))
				return FALSE;
		} else if (ifindex > 0) {
			nm_platform_link_delete (byx_connection_get_platform (self), ifindex);
		}
	}

	g_object_freeze_notify (G_OBJECT (self));
	BYX_CONNECTION_GET_CLASS (self)->unrealize_notify (self);
	...
	priv->capabilities = BYX_CONNECTION_CAP_NM_SUPPORTED;
	...
	byx_connection_state_changed (self,
	                         BYX_CONNECTION_STATE_UNMANAGED,
	                         remove_resources ?
	                             BYX_CONNECTION_STATE_REASON_USER_REQUESTED : BYX_CONNECTION_STATE_REASON_NOW_UNMANAGED);
...
/**
 * byx_connection_notify_component_added():
 * @self: the #ByxConnection
 ...
 */
gboolean
byx_connection_notify_component_added (ByxConnection *self, GObject *component)
{
	ByxConnectionClass *klass;
	ByxConnectionPrivate *priv;
 ...
 */
gboolean
byx_connection_owns_iface (ByxConnection *self, const char *iface)
{
	if (BYX_CONNECTION_GET_CLASS (self)->owns_iface)
		return BYX_CONNECTION_GET_CLASS (self)->owns_iface (self, iface);
	return FALSE;
}

NMConnection *
byx_connection_new_default_connection (ByxConnection *self)
{
	if (BYX_CONNECTION_GET_CLASS (self)->new_default_connection)
		return BYX_CONNECTION_GET_CLASS (self)->new_default_connection (self);
	return NULL;
}

static void
slave_state_changed (ByxConnection *slave,
                     ByxConnectionState slave_new_state,
                     ByxConnectionState slave_old_state,
                     ByxConnectionStateReason reason,
                     ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	_LOGD (LOGD_DEVICE, "slave %s state change %d (%s) -> %d (%s)",
	       byx_connection_get_iface (slave),
	       slave_old_state,
	       byx_connection_state_to_str (slave_old_state),
	       slave_new_state,
	       byx_connection_state_to_str (slave_new_state));

	/* Don't try to enslave slaves until the master is ready */
	if (priv->state < BYX_CONNECTION_STATE_CONFIG)
		return;

	if (slave_new_state == BYX_CONNECTION_STATE_IP_CONFIG)
		byx_connection_master_enslave_slave (self, slave, byx_connection_get_applied_connection (slave));
	else if (slave_new_state > BYX_CONNECTION_STATE_ACTIVATED)
		release = TRUE;
	else if (   slave_new_state <= BYX_CONNECTION_STATE_DISCONNECTED
	         && slave_old_state > BYX_CONNECTION_STATE_DISCONNECTED) {
		/* Catch failures due to unavailable or unmanaged */
		release = TRUE;
	}

	if (release) {
		configure =    priv->sys_iface_state == BYX_CONNECTION_SYS_IFACE_STATE_MANAGED
		            && byx_connection_sys_iface_state_get (slave) != BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL;

		byx_connection_master_release_one_slave (self, slave,
		                                    configure,
		                                    reason);
...
/**
 * byx_connection_master_add_slave:
 * @self: the master device
 * @slave: the slave device to enslave
 ...
 */
static gboolean
byx_connection_master_add_slave (ByxConnection *self, ByxConnection *slave, gboolean configure)
{
	ByxConnectionPrivate *priv;
	ByxConnectionPrivate *slave_priv;
	SlaveInfo *info;
	...
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);
	g_return_val_if_fail (BYX_IS_CONNECTION (slave), FALSE);
	g_return_val_if_fail (BYX_CONNECTION_GET_CLASS (self)->enslave_slave != NULL, FALSE);
	...
	_LOGT (LOGD_CORE, "master: add one slave %p/%s%s", slave, byx_connection_get_iface (slave),
	...
	byx_connection_queue_recheck_assume (self);
	byx_connection_queue_recheck_assume (slave);

	return changed;
}

/**
 * byx_connection_master_check_slave_physical_port:
 * @self: the master device
 * @slave: a slave device
 * @log_domain: domain to log a warning in
 *
 * Checks if @self already has a slave with the same #ByxConnection:physical-port-id
 * as @slave, and logs a warning if so.
 */
void
byx_connection_master_check_slave_physical_port (ByxConnection *self, ByxConnection *slave,
                                            NMLogDomain log_domain)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	slave_physical_port_id = byx_connection_get_physical_port_id (slave);
	...
	c_list_for_each (iter, &priv->slaves) {
		...
		existing_physical_port_id = byx_connection_get_physical_port_id (info->slave);
		if (!g_strcmp0 (slave_physical_port_id, existing_physical_port_id)) {
			_LOGW (log_domain, "slave %s shares a physical port with existing slave %s",
			       byx_connection_get_ip_iface (slave),
			       byx_connection_get_ip_iface (info->slave));
...
/* release all slaves */
static void
byx_connection_master_release_slaves (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	ByxConnectionStateReason reason;
	...
	if (priv->state == BYX_CONNECTION_STATE_FAILED)
		reason = BYX_CONNECTION_STATE_REASON_DEPENDENCY_FAILED;

	if (!nm_platform_link_get (byx_connection_get_platform (self), priv->ifindex))
		configure = FALSE;

	c_list_for_each_safe (iter, safe, &priv->slaves) {
		SlaveInfo *info = c_list_entry (iter, SlaveInfo, lst_slave);

		byx_connection_master_release_one_slave (self, info->slave, configure, reason);
	}
}

/**
 * byx_connection_is_master:
 * @self: the device
 *
 * Returns: %TRUE if the device can have slaves
 */
gboolean
byx_connection_is_master (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);

	return BYX_CONNECTION_GET_CLASS (self)->is_master;
}

/**
 * byx_connection_get_master:
 * @self: the device
 *
 ...
 */
ByxConnection *
byx_connection_get_master (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static gboolean
get_ip_config_may_fail (ByxConnection *self, int addr_family)
{
	NMConnection *connection;
 ...
 */
static void
check_ip_state (ByxConnection *self, gboolean may_fail, gboolean full_state_update)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (   full_state_update
	    && byx_connection_get_state (self) != BYX_CONNECTION_STATE_IP_CONFIG)
		return;
	...
	if (   priv->ip4_state == IP_DONE
		...
		byx_connection_state_changed (self, BYX_CONNECTION_STATE_IP_CHECK, BYX_CONNECTION_STATE_REASON_NONE);
		return;
	}
	...
	if (   (priv->ip4_state == IP_FAIL || (ip4_disabled && priv->ip4_state == IP_DONE))
		 ...
		 * disabled */
		if (byx_connection_sys_iface_state_is_external_or_assume (self)) {
			...
			state = BYX_CONNECTION_STATE_IP_CHECK;
		} else if (   may_fail
			...
			state = BYX_CONNECTION_STATE_SECONDARIES;
		} else {
			/* Autoconfiguration attempted without success. */
			state = BYX_CONNECTION_STATE_FAILED;
		}
		...
		if (   full_state_update
			...
			byx_connection_state_changed (self,
			                         state,
			                         BYX_CONNECTION_STATE_REASON_IP_CONFIG_UNAVAILABLE);
		}
		return;
	}
...
/**
 * byx_connection_slave_notify_enslave:
 ...
 */
static void
byx_connection_slave_notify_enslave (ByxConnection *self, gboolean success)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection = byx_connection_get_applied_connection (self);
	gboolean activating = (priv->state == BYX_CONNECTION_STATE_IP_CONFIG);
	...
	if (!priv->is_enslaved) {
		if (success) {
			if (activating) {
				...
				_LOGI (LOGD_DEVICE, "enslaved to %s", byx_connection_get_iface (priv->master));
	...
	if (activating) {
		if (success)
			...
			byx_connection_queue_state (self, BYX_CONNECTION_STATE_FAILED, BYX_CONNECTION_STATE_REASON_UNKNOWN);
	} else
		byx_connection_queue_recheck_assume (self);
}

/**
 * byx_connection_slave_notify_release:
 * @self: the slave device
 ...
 */
static void
byx_connection_slave_notify_release (ByxConnection *self, ByxConnectionStateReason reason)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection = byx_connection_get_applied_connection (self);
	...
	if (   priv->state > BYX_CONNECTION_STATE_DISCONNECTED
	    && priv->state <= BYX_CONNECTION_STATE_ACTIVATED) {
		switch (byx_connection_state_reason_check (reason)) {
		case BYX_CONNECTION_STATE_REASON_DEPENDENCY_FAILED:
			new_state = BYX_CONNECTION_STATE_FAILED;
			master_status = "failed";
			break;
		case BYX_CONNECTION_STATE_REASON_USER_REQUESTED:
			new_state = BYX_CONNECTION_STATE_DEACTIVATING;
			reason = BYX_CONNECTION_STATE_REASON_DEPENDENCY_FAILED;
			master_status = "deactivated by user request";
			break;
		default:
			new_state = BYX_CONNECTION_STATE_DISCONNECTED;
		...
		byx_connection_queue_state (self, new_state, reason);
	} else
		_LOGI (LOGD_DEVICE, "released from master device %s", byx_connection_get_iface (priv->master));
 ...
 */
void
byx_connection_removed (ByxConnection *self, gboolean unconfigure_ip_config)
{
	ByxConnectionPrivate *priv;
	...
	byx_connection_set_ip_config (self, AF_INET, NULL, FALSE, NULL);
	byx_connection_set_ip_config (self, AF_INET6, NULL, FALSE, NULL);
}

static gboolean
is_available (ByxConnection *self, ByxConnectionCheckDevAvailableFlags flags)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
 ...
 * %BYX_CONNECTION_STATE_UNAVAILABLE when byx_connection_is_available() returns
 * %TRUE. (But note that it can still be %BYX_CONNECTION_STATE_UNMANAGED
 * when it is available.)
 *
 * Returns: %TRUE or %FALSE
 */
gboolean
byx_connection_is_available (ByxConnection *self, ByxConnectionCheckDevAvailableFlags flags)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	return BYX_CONNECTION_GET_CLASS (self)->is_available (self, flags);
}

gboolean
byx_connection_ignore_carrier_by_default (ByxConnection *self)
{
	/* master types ignore-carrier by default. */
	return byx_connection_is_master (self);
}

gboolean
byx_connection_get_enabled (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);

	if (BYX_CONNECTION_GET_CLASS (self)->get_enabled)
		return BYX_CONNECTION_GET_CLASS (self)->get_enabled (self);
	return TRUE;
}

void
byx_connection_set_enabled (ByxConnection *self, gboolean enabled)
{
	g_return_if_fail (BYX_IS_CONNECTION (self));

	if (BYX_CONNECTION_GET_CLASS (self)->set_enabled)
		BYX_CONNECTION_GET_CLASS (self)->set_enabled (self, enabled);
}

NM_UTILS_FLAGS2STR_DEFINE_STATIC (_autoconnect_blocked_flags_to_string, ByxConnectionAutoconnectBlockedFlags,
	NM_UTILS_FLAGS2STR (BYX_CONNECTION_AUTOCONNECT_BLOCKED_NONE,              "none"),
	NM_UTILS_FLAGS2STR (BYX_CONNECTION_AUTOCONNECT_BLOCKED_USER,              "user"),
	NM_UTILS_FLAGS2STR (BYX_CONNECTION_AUTOCONNECT_BLOCKED_WRONG_PIN,         "wrong-pin"),
	NM_UTILS_FLAGS2STR (BYX_CONNECTION_AUTOCONNECT_BLOCKED_MANUAL_DISCONNECT, "manual-disconnect"),
);

ByxConnectionAutoconnectBlockedFlags
byx_connection_autoconnect_blocked_get (ByxConnection *self, ByxConnectionAutoconnectBlockedFlags mask)
{
	ByxConnectionPrivate *priv;
	...
	if (mask == 0)
		mask = BYX_CONNECTION_AUTOCONNECT_BLOCKED_ALL;
...
void
byx_connection_autoconnect_blocked_set_full (ByxConnection *self, ByxConnectionAutoconnectBlockedFlags mask, ByxConnectionAutoconnectBlockedFlags value)
{
	ByxConnectionPrivate *priv;
	gboolean changed;
...
/**
 * byx_connection_autoconnect_allowed:
 * @self: the #ByxConnection
 *
 ...
 */
gboolean
byx_connection_autoconnect_allowed (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	ByxConnectionClass *klass = BYX_CONNECTION_GET_CLASS (self);
	...
	if (byx_connection_autoconnect_blocked_get (self, BYX_CONNECTION_AUTOCONNECT_BLOCKED_ALL))
		return FALSE;
	...
	if (!byx_connection_get_enabled (self))
		return FALSE;
...
static gboolean
can_auto_connect (ByxConnection *self,
                  NMConnection *connection,
...
/**
 * byx_connection_can_auto_connect:
 * @self: an #ByxConnection
 ...
 *   byx_manager_activate_connection(), or %NULL.
 *
 ...
 **/
gboolean
byx_connection_can_auto_connect (ByxConnection *self,
                            NMConnection *connection,
                            char **specific_object)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);
	...
	/* the caller must ensure that byx_connection_autoconnect_allowed() returns
	 * TRUE as well. This is done, because byx_connection_can_auto_connect()
	 * has only one caller, and it iterates over a list of available
	 * connections.
	 *
	 * Hence, we don't need to re-check byx_connection_autoconnect_allowed()
	 * over and over again. The caller is supposed to do that. */
	nm_assert (byx_connection_autoconnect_allowed (self));

	if (!byx_connection_check_connection_available (self, connection, BYX_CONNECTION_CHECK_CON_AVAILABLE_NONE, NULL))
		return FALSE;

	if (!BYX_CONNECTION_GET_CLASS (self)->can_auto_connect (self, connection, specific_object))
		return FALSE;
...
static gboolean
device_has_config (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (   !c_list_is_empty (&priv->slaves)
	    || nm_platform_link_get_master (byx_connection_get_platform (self), priv->ifindex) > 0)
		return TRUE;
...
/**
 * byx_connection_master_update_slave_connection:
 * @self: the master #ByxConnection
 * @slave: the slave #ByxConnection
 ...
 */
gboolean
byx_connection_master_update_slave_connection (ByxConnection *self,
                                          ByxConnection *slave,
                                          NMConnection *connection,
                                          GError **error)
{
	...
	g_return_val_if_fail (byx_connection_get_iface (self), FALSE);
	...
	g_set_error (error,
	             ...
	             byx_connection_get_iface (self), byx_connection_get_iface (slave));
	return FALSE;
}

NMConnection *
byx_connection_generate_connection (ByxConnection *self,
                               ByxConnection *master,
                               ...
                               GError **error)
{
	ByxConnectionClass *klass = BYX_CONNECTION_GET_CLASS (self);
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	const char *ifname = byx_connection_get_iface (self);
	...
	g_object_set (s_con,
	              NM_SETTING_CONNECTION_UUID, byx_utils_uuid_generate_buf (uuid),
	...
	if (master) {
		if (!byx_connection_master_update_slave_connection (master,
		                                               self,
		                                               connection,
		                                               &local)) {
			g_set_error (error, BYX_CONNECTION_ERROR, BYX_CONNECTION_ERROR_FAILED,
			             "master device '%s' failed to update slave connection: %s",
			             byx_connection_get_iface (master), local->message);
			g_error_free (local);
			return NULL;
		}
	} else {
		...
		pllink = nm_platform_link_get (byx_connection_get_platform (self), priv->ifindex);
		if (pllink && pllink->inet6_token.id) {
			g_object_set (s_ip6,
			              NM_SETTING_IP6_CONFIG_ADDR_GEN_MODE, NM_IN6_ADDR_GEN_MODE_EUI64,
			              NM_SETTING_IP6_CONFIG_TOKEN, byx_utils_inet6_interface_identifier_to_token (pllink->inet6_token, NULL),
			              NULL);
		}
	}
	 ...
	 */
	ip4_method = byx_utils_get_ip_config_method (connection, NM_TYPE_SETTING_IP4_CONFIG);
	ip6_method = byx_utils_get_ip_config_method (connection, NM_TYPE_SETTING_IP6_CONFIG);
...
/**
 * byx_connection_complete_connection:
 *
 ...
 */
gboolean
byx_connection_complete_connection (ByxConnection *self,
                               NMConnection *connection,
                               ...
                               GError **error)
{
	...
	if (!klass->complete_connection) {
		g_set_error (error, BYX_CONNECTION_ERROR, BYX_CONNECTION_ERROR_INVALID_CONNECTION,
...
gboolean
byx_connection_match_parent (ByxConnection *self, const char *parent)
{
	ByxConnection *parent_device;

	g_return_val_if_fail (parent, FALSE);

	parent_device = byx_connection_parent_get_device (self);
	if (!parent_device)
		return FALSE;

	if (byx_utils_is_uuid (parent)) {
		NMConnection *connection;
...
gboolean
byx_connection_match_hwaddr (ByxConnection *device,
                        NMConnection *connection,
                        gboolean fail_if_no_hwaddr)
{
	...
	parent_device = byx_connection_parent_get_device (device);
	if (!parent_device)
		return !fail_if_no_hwaddr;

	parent_mac = byx_connection_get_permanent_hw_address (parent_device);
	return parent_mac && byx_utils_hwaddr_matches (setting_mac, -1, parent_mac, -1);
}
...
/**
 * byx_connection_check_connection_compatible:
 * @self: an #ByxConnection
 ...
 */
gboolean
byx_connection_check_connection_compatible (ByxConnection *self, NMConnection *connection)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);
	g_return_val_if_fail (NM_IS_CONNECTION (connection), FALSE);

	return BYX_CONNECTION_GET_CLASS (self)->check_connection_compatible (self, connection);
}

gboolean
byx_connection_check_slave_connection_compatible (ByxConnection *self, NMConnection *slave)
{
	NMSettingConnection *s_con;
	...
	connection_type = BYX_CONNECTION_GET_CLASS (self)->connection_type;
...
/**
 * byx_connection_can_assume_connections:
 * @self: #ByxConnection instance
 *
 ...
 */
static gboolean
byx_connection_can_assume_connections (ByxConnection *self)
{
	return !!BYX_CONNECTION_GET_CLASS (self)->update_connection;
}

static gboolean
unmanaged_on_quit (ByxConnection *self)
{
	NMConnection *connection;

	/* ByxConnectionWifi overwrites this function to always unmanage wifi devices.
	 *
	...
	if (!byx_connection_can_assume_connections (self))
		return TRUE;

	/* the only exception are IPv4 shared connections. We unmanage them on quit. */
	connection = byx_connection_get_applied_connection (self);
	if (connection) {
		if (NM_IN_STRSET (byx_utils_get_ip_config_method (connection, NM_TYPE_SETTING_IP4_CONFIG),
...
gboolean
byx_connection_unmanage_on_quit (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);

	return BYX_CONNECTION_GET_CLASS (self)->unmanaged_on_quit (self);
}

static gboolean
byx_connection_emit_recheck_assume (gpointer user_data)
{
	ByxConnection *self = user_data;
	ByxConnectionPrivate *priv;
	...
	if (!byx_connection_get_act_request (self))
...
void
byx_connection_queue_recheck_assume (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);

	if (   !priv->recheck_assume_id
	    && byx_connection_can_assume_connections (self))
		priv->recheck_assume_id = g_idle_add (byx_connection_emit_recheck_assume, self);
}
...
recheck_available (gpointer user_data)
{
	...
	ByxConnectionState state = byx_connection_get_state (self);
	ByxConnectionState new_state = BYX_CONNECTION_STATE_UNKNOWN;

	priv->recheck_available.call_id = 0;

	now_available = byx_connection_is_available (self, BYX_CONNECTION_CHECK_DEV_AVAILABLE_NONE);

	if (state == BYX_CONNECTION_STATE_UNAVAILABLE && now_available) {
		new_state = BYX_CONNECTION_STATE_DISCONNECTED;
		byx_connection_queue_state (self, new_state, priv->recheck_available.available_reason);
	} else if (state >= BYX_CONNECTION_STATE_DISCONNECTED && !now_available) {
		new_state = BYX_CONNECTION_STATE_UNAVAILABLE;
		byx_connection_queue_state (self, new_state, priv->recheck_available.unavailable_reason);
	}

	if (new_state > BYX_CONNECTION_STATE_UNKNOWN) {
		_LOGD (LOGD_DEVICE, "is %savailable, %s %s",
		       now_available ? "" : "not ",
		       new_state == BYX_CONNECTION_STATE_UNAVAILABLE ? "no change required for" : "will transition to",
		       byx_connection_state_to_str (new_state == BYX_CONNECTION_STATE_UNAVAILABLE ? state : new_state));

		priv->recheck_available.available_reason = BYX_CONNECTION_STATE_REASON_NONE;
		priv->recheck_available.unavailable_reason = BYX_CONNECTION_STATE_REASON_NONE;
	}

	if (priv->recheck_available.call_id == 0)
		byx_connection_remove_pending_action (self, NM_PENDING_ACTION_RECHECK_AVAILABLE, TRUE);

	return G_SOURCE_REMOVE;
}

void
byx_connection_queue_recheck_available (ByxConnection *self,
                                   ByxConnectionStateReason available_reason,
                                   ByxConnectionStateReason unavailable_reason)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (!priv->recheck_available.call_id) {
		...
		byx_connection_add_pending_action (self, NM_PENDING_ACTION_RECHECK_AVAILABLE,
...
void
byx_connection_emit_recheck_auto_activate (ByxConnection *self)
{
...
dnsmasq_state_changed_cb (NMDnsMasqManager *manager, guint32 status, gpointer user_data)
{
	...
	case NM_DNSMASQ_STATUS_DEAD:
		byx_connection_ip_method_failed (self, AF_INET, BYX_CONNECTION_STATE_REASON_SHARED_START_FAILED);
		break;
	default:
		break;
	}
...
activation_source_get_by_family (ByxConnection *self,
                                 int addr_family,
...
static void
activation_source_clear (ByxConnection *self,
                         int addr_family)
{
...
static void
activation_source_handle_cb (ByxConnection *self,
                             int addr_family)
{
...
static void
activation_source_schedule (ByxConnection *self, ActivationHandleFunc func, int addr_family)
{
	ActivationHandleData *act_data;
...
static gboolean
activation_source_is_scheduled (ByxConnection *self,
                                ActivationHandleFunc func,
                                int addr_family)
{
	ActivationHandleData *act_data;
...
static void
master_ready (ByxConnection *self,
              NMActiveConnection *active)
{
	...
	g_return_if_fail (priv->state == BYX_CONNECTION_STATE_PREPARE);
	...
	byx_connection_master_add_slave (master,
	                            self,
	                            !byx_connection_sys_iface_state_is_external_or_assume (self));
}
                 ...
                 ByxConnection *self)
{
	...
	byx_connection_activate_schedule_stage2_device_config (self);
}
...
static gboolean
lldp_rx_enabled (ByxConnection *self)
{
	NMConnection *connection;
	NMSettingConnection *s_con;
...
act_stage1_prepare (ByxConnection *self, ByxConnectionStateReason *out_failure_reason)
{
 ...
 */
static void
activate_stage1_device_prepare (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	byx_connection_state_changed (self, BYX_CONNECTION_STATE_PREPARE, BYX_CONNECTION_STATE_REASON_NONE);

	/* Assumed connections were already set up outside NetworkManager */
	if (!byx_connection_sys_iface_state_is_external_or_assume (self)) {
		ByxConnectionStateReason failure_reason = BYX_CONNECTION_STATE_REASON_NONE;

		ret = BYX_CONNECTION_GET_CLASS (self)->act_stage1_prepare (self, &failure_reason);
		if (ret == NM_ACT_STAGE_RETURN_POSTPONE) {
			return;
		} else if (ret == NM_ACT_STAGE_RETURN_FAILURE) {
			byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, failure_reason);
			return;
		}
...
/*
 * byx_connection_activate_schedule_stage1_device_prepare
 *
 * Prepare a device for activation
 *
 */
void
byx_connection_activate_schedule_stage1_device_prepare (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
static NMActStageReturn
act_stage2_config (ByxConnection *self, ByxConnectionStateReason *out_failure_reason)
{
	return NM_ACT_STAGE_RETURN_SUCCESS;
}

static void
lldp_init (ByxConnection *self, gboolean restart)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
tc_commit (ByxConnection *self)
{
	...
	ip_ifindex = byx_connection_get_ip_ifindex (self);
	if (!ip_ifindex)
	       return s_tc == NULL;
	...
	if (!nm_platform_qdisc_sync (byx_connection_get_platform (self), ip_ifindex, qdiscs))
		return FALSE;

	if (!nm_platform_tfilter_sync (byx_connection_get_platform (self), ip_ifindex, tfilters))
		return FALSE;
 ...
 */
static void
activate_stage2_device_config (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	byx_connection_state_changed (self, BYX_CONNECTION_STATE_CONFIG, BYX_CONNECTION_STATE_REASON_NONE);
	...
	if (!byx_connection_sys_iface_state_is_external_or_assume (self)) {
		...
		if (!tc_commit (self)) {
			...
			byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, BYX_CONNECTION_STATE_REASON_CONFIG_FAILED);
		}

		if (!byx_connection_bring_up (self, FALSE, &no_firmware)) {
			if (no_firmware)
				byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, BYX_CONNECTION_STATE_REASON_FIRMWARE_MISSING);
			else
				byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, BYX_CONNECTION_STATE_REASON_CONFIG_FAILED);
			return;
		}

		ret = BYX_CONNECTION_GET_CLASS (self)->act_stage2_config (self, &failure_reason);
		if (ret == NM_ACT_STAGE_RETURN_POSTPONE)
			return;
		else if (ret == NM_ACT_STAGE_RETURN_FAILURE) {
			byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, failure_reason);
	...
	c_list_for_each (iter, &priv->slaves) {
		SlaveInfo *info = c_list_entry (iter, SlaveInfo, lst_slave);
		ByxConnectionState slave_state = byx_connection_get_state (info->slave);

		if (slave_state == BYX_CONNECTION_STATE_IP_CONFIG)
			byx_connection_master_enslave_slave (self, info->slave, byx_connection_get_applied_connection (info->slave));
		else if (   priv->act_request.obj
		         && byx_connection_sys_iface_state_is_external (self)
		         && slave_state <= BYX_CONNECTION_STATE_DISCONNECTED)
			byx_connection_queue_recheck_assume (info->slave);
	}

	lldp_init (self, TRUE);
	byx_connection_activate_schedule_stage3_ip_config_start (self);
}

/*
 * byx_connection_activate_schedule_stage2_device_config
 *
 * Schedule setup of the hardware device
 *
 */
void
byx_connection_activate_schedule_stage2_device_config (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
	...
	if (!priv->master_ready_handled) {
		...
		if (!master) {
			...
			if (nm_active_connection_get_master_ready (active))
				...
				byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, BYX_CONNECTION_STATE_REASON_DEPENDENCY_FAILED);
			} else {
...
void
byx_connection_ip_method_failed (ByxConnection *self,
                            int addr_family,
                            ByxConnectionStateReason reason)
{
	g_return_if_fail (BYX_IS_CONNECTION (self));
	...
	if (get_ip_config_may_fail (self, addr_family))
		check_ip_state (self, FALSE, (byx_connection_get_state (self) == BYX_CONNECTION_STATE_IP_CONFIG));
	else
		byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, reason);
}
...
static guint
get_ipv4_dad_timeout (ByxConnection *self)
{
	NMConnection *connection;
...
static void
ipv4_manual_method_apply (ByxConnection *self, NMIP4Config **configs, gboolean success)
{
	NMIP4Config *empty;

	if (success) {
		empty = _ip4_config_new (self);
		byx_connection_activate_schedule_ip4_config_result (self, empty);
		g_object_unref (empty);
	} else {
		byx_connection_ip_method_failed (self, AF_INET,
		                            BYX_CONNECTION_STATE_REASON_IP_ADDRESS_DUPLICATE);
	}
}
	...
	for (i = 0; data->configs && data->configs[i]; i++) {
		nm_ip_config_iter_ip4_address_for_each (&ipconf_iter, data->configs[i], &address) {
			...
			_NMLOG (result ? LOGL_DEBUG : LOGL_WARN,
			        ...
			        byx_utils_inet4_ntop (address->address, NULL),
 ...
 */
static void
ipv4_dad_start (ByxConnection *self, NMIP4Config **configs, AcdCallback cb)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	hwaddr_arr = nm_platform_link_get_address (byx_connection_get_platform (self),
	                                           byx_connection_get_ip_ifindex (self),
	                                           &length);
	...
	acd_manager = nm_acd_manager_new (byx_connection_get_ip_ifindex (self), hwaddr_arr, length);
...
static void
ipv4ll_cleanup (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static NMIP4Config *
ipv4ll_get_ip4_config (ByxConnection *self, guint32 lla)
{
	...
	route.table_coerced = nm_platform_route_table_coerce (byx_connection_get_route_table (self, AF_INET, TRUE));
	route.metric = byx_connection_get_route_metric (self, AF_INET);
...
static void
byx_connection_handle_ipv4ll_event (sd_ipv4ll *ll, int event, void *data)
{
	ByxConnection *self = data;
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection = NULL;
	const char *method;
	...
	case SD_IPV4LL_EVENT_BIND:
		...
		if (r < 0) {
			...
			byx_connection_ip_method_failed (self, AF_INET, BYX_CONNECTION_STATE_REASON_AUTOIP_START_FAILED);
			return;
		}
		...
		if ((address.s_addr & IPV4LL_NETMASK) != IPV4LL_NETWORK) {
			...
			byx_connection_ip_method_failed (self, AF_INET, BYX_CONNECTION_STATE_REASON_AUTOIP_ERROR);
			return;
		}
		...
		if (config == NULL) {
			...
			byx_connection_ip_method_failed (self, AF_INET, BYX_CONNECTION_STATE_REASON_AUTOIP_FAILED);
			return;
		}

		if (priv->ip4_state == IP_CONF) {
			nm_clear_g_source (&priv->ipv4ll_timeout);
			byx_connection_activate_schedule_ip4_config_result (self, config);
...
ipv4ll_timeout_cb (gpointer user_data)
{
	...
	if (priv->ipv4ll_timeout) {
		...
		if (priv->ip4_state == IP_CONF)
			byx_connection_activate_schedule_ip4_config_timeout (self);
	}
...
static NMActStageReturn
ipv4ll_start (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	ifindex = byx_connection_get_ip_ifindex (self);
	addr = nm_platform_link_get_address (byx_connection_get_platform (self), ifindex, &addr_len);
	...
	r = sd_ipv4ll_set_callback (priv->ipv4ll, byx_connection_handle_ipv4ll_event, self);
	if (r < 0) {
...
static void
ensure_con_ip_config (ByxConnection *self, int addr_family)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection;
	...
	if (IS_IPv4) {
		nm_ip4_config_merge_setting (NM_IP4_CONFIG (con_ip_config),
		                             nm_connection_get_setting_ip4_config (connection),
		                             _get_mdns (self),
		                             byx_connection_get_route_table (self, addr_family, TRUE),
		                             byx_connection_get_route_metric (self, addr_family));
	} else {
...
static void
dhcp4_cleanup (ByxConnection *self, CleanupType cleanup_type, gboolean release)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (priv->dhcp4.client) {
		...
		byx_connection_remove_pending_action (self, NM_PENDING_ACTION_DHCP4, FALSE);
...
static gboolean
ip_config_merge_and_apply (ByxConnection *self,
                           int addr_family,
                           gboolean commit)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (!IS_IPv4) {
		if (   commit
			...
			const NMPlatformIP6Route ll_r = {
				...
				.plen = 64,
				.metric = byx_connection_get_route_metric (self, addr_family),
	...
	if (IS_IPv4) {
		if (commit) {
			if (BYX_CONNECTION_GET_CLASS (self)->ip4_config_pre_commit)
				BYX_CONNECTION_GET_CLASS (self)->ip4_config_pre_commit (self, NM_IP4_CONFIG (composite));
		}
	}
	...
	if (!IS_IPv4) {
		if (commit) {
			...
			if (   ip6_addr_gen_token
			    && byx_utils_ipv6_interface_identifier_get_from_token (&iid, ip6_addr_gen_token)) {
				nm_platform_link_set_ipv6_token (byx_connection_get_platform (self),
				                                 byx_connection_get_ip_ifindex (self),
				                                 iid);
			}
		}
	...
	success = byx_connection_set_ip_config (self, addr_family, composite, commit, ip4_dev_route_blacklist);
	if (commit) {
		if (IS_IPv4)
...
static gboolean
dhcp4_lease_change (ByxConnection *self, NMIP4Config *config)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
dhcp4_grace_period_expired (gpointer user_data)
{
	...
	byx_connection_ip_method_failed (self, AF_INET,
	                            BYX_CONNECTION_STATE_REASON_IP_CONFIG_EXPIRED);
...
static void
dhcp4_dad_cb (ByxConnection *self, NMIP4Config **configs, gboolean success)
{
	if (success)
		byx_connection_activate_schedule_ip4_config_result (self, configs[1]);
	else {
		byx_connection_ip_method_failed (self, AF_INET,
		                            BYX_CONNECTION_STATE_REASON_IP_ADDRESS_DUPLICATE);
	}
	...
	case NM_DHCP_STATE_BOUND:
		...
		if (priv->ip4_state == IP_CONF) {
			...
			nm_ip4_config_merge_setting (manual,
			                             nm_connection_get_setting_ip4_config (connection),
			                             NM_SETTING_CONNECTION_MDNS_DEFAULT,
			                             byx_connection_get_route_table (self, AF_INET, TRUE),
			                             byx_connection_get_route_metric (self, AF_INET));
			...
			if (dhcp4_lease_change (self, ip4_config))
				byx_connection_update_metered (self);
			else
				dhcp4_fail (self);
		}
		break;
...
static int
get_dhcp_timeout (ByxConnection *self, int addr_family)
{
	ByxConnectionClass *klass;
	NMConnection *connection;
	NMSettingIPConfig *s_ip;
...

	{
		...
		value = nm_config_data_get_connection_default (NM_CONFIG_GET_DATA,
		                                               addr_family == AF_INET
		                                                 ...
		                                                 : "ipv6.dhcp-timeout",
		                                               self);
		timeout = _byx_utils_ascii_str_to_int64 (value, 10,
		                                        0, G_MAXINT32, 0);
		if (timeout)
			return timeout;
	}
...
static GBytes *
dhcp4_get_client_id (ByxConnection *self,
                     NMConnection *connection,
                     GBytes *hwaddr)
{
	...
	if (nm_streq (client_id, "perm-mac")) {
		...
		if (!_byx_utils_hwaddr_aton (hwaddr_str, hwaddr_bin_buf, sizeof (hwaddr_bin_buf), &hwaddr_len))
			g_return_val_if_reached (NULL);
	...
	if (nm_streq (client_id, "stable")) {
		...
		byx_utils_secret_key_get (&secret_key, &secret_key_len);
...
out_fail:
	...
	client_id_buf = g_malloc (1 + 15);
	client_id_buf[0] = 0;
	byx_utils_random_bytes (&client_id_buf[1], 15);
	result = g_bytes_new_take (client_id_buf, 1 + 15);
...
static NMActStageReturn
dhcp4_start (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMSettingIPConfig *s_ip4;
	...
	hwaddr = nm_platform_link_get_address_as_bytes (byx_connection_get_platform (self),
	                                                byx_connection_get_ip_ifindex (self));
	...
	priv->dhcp4.client = nm_dhcp_manager_start_ip4 (nm_dhcp_manager_get (),
	                                                nm_netns_get_multi_idx (byx_connection_get_netns (self)),
	                                                byx_connection_get_ip_iface (self),
	                                                byx_connection_get_ip_ifindex (self),
	                                                hwaddr,
	...
	byx_connection_add_pending_action (self, NM_PENDING_ACTION_DHCP4, TRUE);
...
gboolean
byx_connection_dhcp4_renew (ByxConnection *self, gboolean release)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static NMIP4Config *
shared4_new_config (ByxConnection *self, NMConnection *connection)
{
	NMIP4Config *config = NULL;
...
{
	const char *method = byx_utils_get_ip_config_method (connection, NM_TYPE_SETTING_IP4_CONFIG);
...
{
	const char *method = byx_utils_get_ip_config_method (connection, NM_TYPE_SETTING_IP6_CONFIG);
...
static gboolean
have_any_ready_slaves (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	SlaveInfo *info;
	CList *iter;
	...
	c_list_for_each (iter, &priv->slaves) {
		info = c_list_entry (iter, SlaveInfo, lst_slave);
		if (BYX_CONNECTION_GET_PRIVATE (info->slave)->is_enslaved)
			return TRUE;
	}
	return FALSE;
}
...
static NMActStageReturn
act_stage3_ip4_config_start (ByxConnection *self,
                             ...
                             ByxConnectionStateReason *out_failure_reason)
{
	...
	if (byx_connection_is_master (self) && ip4_requires_slaves (connection)) {
	...
	if (strcmp (method, NM_SETTING_IP4_CONFIG_METHOD_AUTO) == 0) {
		...
		if (ret == NM_ACT_STAGE_RETURN_FAILURE)
			NM_SET_OUT (out_failure_reason, BYX_CONNECTION_STATE_REASON_DHCP_START_FAILED);
	} else if (strcmp (method, NM_SETTING_IP4_CONFIG_METHOD_LINK_LOCAL) == 0) {
		ret = ipv4ll_start (self);
		if (ret == NM_ACT_STAGE_RETURN_FAILURE)
			NM_SET_OUT (out_failure_reason, BYX_CONNECTION_STATE_REASON_AUTOIP_START_FAILED);
		...
		if (out_config) {
			*out_config = shared4_new_config (self, connection);
			if (*out_config) {
				priv->dnsmasq_manager = nm_dnsmasq_manager_new (byx_connection_get_ip_iface (self));
				ret = NM_ACT_STAGE_RETURN_SUCCESS;
			} else {
				NM_SET_OUT (out_failure_reason, BYX_CONNECTION_STATE_REASON_IP_CONFIG_UNAVAILABLE);
...
static void
dhcp6_cleanup (ByxConnection *self, CleanupType cleanup_type, gboolean release)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	byx_connection_remove_pending_action (self, NM_PENDING_ACTION_DHCP6, FALSE);
...
static gboolean
dhcp6_lease_change (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
dhcp6_grace_period_expired (gpointer user_data)
{
	...
	byx_connection_ip_method_failed (self, AF_INET6,
	                            BYX_CONNECTION_STATE_REASON_IP_CONFIG_EXPIRED);
	/* If the device didn't fail, the DHCP client will continue */
...
static void
dhcp6_fail (ByxConnection *self, gboolean timeout)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (is_dhcp_managed) {
		...
		if (   !priv->dhcp6.was_active
			...
			byx_connection_activate_schedule_ip6_config_timeout (self);
			return;
		}
		...
		if (priv->ip6_state == IP_CONF)
			byx_connection_activate_schedule_ip6_config_result (self);
	}
	return;
...
static void
dhcp6_timeout (ByxConnection *self, NMDhcpClient *client)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
                     ...
                     gpointer user_data)
{
	...
	case NM_DHCP_STATE_BOUND:
		...
		if (priv->ip6_state == IP_CONF) {
			if (!applied_config_get_current (&priv->dhcp6.ip6_config)) {
				byx_connection_ip_method_failed (self, AF_INET6, BYX_CONNECTION_STATE_REASON_DHCP_FAILED);
				break;
			}
			byx_connection_activate_schedule_ip6_config_result (self);
...
generate_duid_from_machine_id (void)
{
	...
	machine_id_s = byx_utils_machine_id_read ();
	if (!byx_utils_machine_id_parse (machine_id_s, uuid))
		return NULL;
...
static GBytes *
dhcp6_get_duid (ByxConnection *self, NMConnection *connection, GBytes *hwaddr, gboolean *out_enforce)
{
	...
	if (!_byx_utils_dhcp_duid_valid (duid, &duid_out)) {
	...
	if (NM_IN_STRSET (duid, "ll", "llt")) {
		...
		if (nm_streq (duid, "ll")) {
			...
			time = byx_utils_secret_key_get_timestamp ();
			if (!time) {
...
out_fail:
	nm_assert (!duid_out && duid_error);
	{
		...
		byx_utils_random_bytes (uuid, sizeof (uuid));
...
static gboolean
dhcp6_start_with_link_ready (ByxConnection *self, NMConnection *connection)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMSettingIPConfig *s_ip6;
	gs_unref_bytes GBytes *hwaddr = NULL;
	...
	priv->dhcp6.client = nm_dhcp_manager_start_ip6 (nm_dhcp_manager_get (),
	                                                byx_connection_get_multi_index (self),
	                                                byx_connection_get_ip_iface (self),
	                                                byx_connection_get_ip_ifindex (self),
	                                                hwaddr,
	                                                &ll_addr->address,
	                                                nm_connection_get_uuid (connection),
	                                                byx_connection_get_route_table (self, AF_INET6, TRUE),
	                                                byx_connection_get_route_metric (self, AF_INET6),
...
static gboolean
dhcp6_start (ByxConnection *self, gboolean wait_for_ll)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection;
	NMSettingIPConfig *s_ip6;
	...
	if (!nm_setting_ip_config_get_may_fail (s_ip6) ||
		...
		byx_connection_add_pending_action (self, NM_PENDING_ACTION_DHCP6, TRUE);
...
gboolean
byx_connection_dhcp6_renew (ByxConnection *self, gboolean release)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
 ...
 */
void
byx_connection_request_ip6_prefixes (ByxConnection *self, int needed_prefixes)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (priv->dhcp6.client) {
		...
		byx_connection_dhcp6_renew (self, FALSE);
	} else {
...
gboolean
byx_connection_needs_ip6_subnet (ByxConnection *self)
{
	return BYX_CONNECTION_GET_PRIVATE (self)->needs_ip6_subnet;
}
 ...
 */
void
byx_connection_use_ip6_subnet (ByxConnection *self, const NMPlatformIP6Address *subnet)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	_LOGD (LOGD_IP6, "ipv6-pd: using %s address (preferred for %u seconds)",
	       byx_utils_inet6_ntop (&address.address, NULL),
	       subnet->preferred);
 ...
 */
void
byx_connection_copy_ip6_dns_config (ByxConnection *self, ByxConnection *from_device)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (from_device)
		from_config = byx_connection_get_ip6_config (from_device);
	if (!from_config)
		return;
...
static void
linklocal6_failed (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
linklocal6_check_complete (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection;
	const char *method;
	...
	method = byx_utils_get_ip_config_method (connection, NM_TYPE_SETTING_IP6_CONFIG);
...
static void
check_and_add_ipv6ll_addr (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (s_ip6 && nm_setting_ip6_config_get_addr_gen_mode (s_ip6) == NM_SETTING_IP6_CONFIG_ADDR_GEN_MODE_STABLE_PRIVACY) {
		...
		stable_id = _get_stable_id (self, connection, &stable_type);
		if (   !stable_id
		    || !byx_utils_ipv6_addr_set_stable_privacy (stable_type,
		                                               &lladdr,
		                                               byx_connection_get_iface (self),
		                                               stable_id,
		...
		if (!byx_connection_get_ip_iface_identifier (self, &iid, TRUE)) {
			_LOGW (LOGD_IP6, "linklocal6: failed to get interface identifier; IPv6 cannot continue");
			return;
		}
		byx_utils_ipv6_addr_set_interface_identifier (&lladdr, iid);
		addr_type = "EUI-64";
	}

	_LOGD (LOGD_IP6, "linklocal6: generated %s IPv6LL address %s", addr_type, byx_utils_inet6_ntop (&lladdr, NULL));
...
static gboolean
linklocal6_start (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection;
	const char *method;
...
guint32
byx_connection_get_configured_mtu_from_connection (ByxConnection *self,
                                              GType setting_type,
                                              ByxConnectionMtuSource *out_source)
{
	...
	if (mtu) {
		*out_source = BYX_CONNECTION_MTU_SOURCE_CONNECTION;
		return mtu;
	}

	mtu_default = byx_connection_get_configured_mtu_from_connection_default (self, global_property_name);
	if (mtu_default >= 0) {
		*out_source = BYX_CONNECTION_MTU_SOURCE_CONNECTION;
		return (guint32) mtu_default;
	}

	*out_source = BYX_CONNECTION_MTU_SOURCE_NONE;
	return 0;
}

guint32
byx_connection_get_configured_mtu_for_wired (ByxConnection *self, ByxConnectionMtuSource *out_source)
{
	return byx_connection_get_configured_mtu_from_connection (self,
...
static void
_set_mtu (ByxConnection *self, guint32 mtu)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (priv->master) {
		...
		byx_connection_commit_mtu (priv->master);
	}
}

static void
_commit_mtu (ByxConnection *self, const NMIP4Config *config)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	ByxConnectionMtuSource source = BYX_CONNECTION_MTU_SOURCE_NONE;
	...
	if (   !byx_connection_get_applied_connection (self)
	    || byx_connection_sys_iface_state_is_external_or_assume (self)) {
...

	{
		...
		if (BYX_CONNECTION_GET_CLASS (self)->get_configured_mtu)
			mtu = BYX_CONNECTION_GET_CLASS (self)->get_configured_mtu (self, &source);

		if (   config
		    && source < BYX_CONNECTION_MTU_SOURCE_IP_CONFIG
		...
		if (   mtu != 0
		    && (   source > priv->mtu_source
		        || (priv->mtu_source == BYX_CONNECTION_MTU_SOURCE_PARENT && source == priv->mtu_source)))
			mtu_desired = mtu;
		else {
			mtu_desired = 0;
			source = BYX_CONNECTION_MTU_SOURCE_NONE;
		}
	}
	...
	if (!ip6_mtu && priv->mtu_source == BYX_CONNECTION_MTU_SOURCE_NONE) {
	...
	mtu_plat = nm_platform_link_get_mtu (byx_connection_get_platform (self), ifindex);
...
#define _IP6_MTU_SYS() \
	({ \
		if (!ip6_mtu_sysctl.initialized) { \
			ip6_mtu_sysctl.value = byx_connection_ipv6_sysctl_get_uint32 (self, "mtu", 0); \
	...
	if (   (mtu_desired && mtu_desired != mtu_plat)
		...
		if (mtu_desired && mtu_desired != mtu_plat) {
			if (nm_platform_link_set_mtu (byx_connection_get_platform (self), ifindex, mtu_desired) == NM_PLATFORM_ERROR_CANT_SET_MTU) {
				anticipated_failure = TRUE;
				success = FALSE;
				_LOGW (LOGD_DEVICE, "mtu: failure to set MTU. %s",
				       BYX_IS_CONNECTION_VLAN (self)
				         ? "Is the parent's MTU size large enough?"
				         : (!c_list_is_empty (&priv->slaves)
				              ? "Are the MTU sizes of the slaves large enough?"
				              : "Did you configure the MTU correctly?"));
			}
			priv->carrier_wait_until_ms = byx_utils_get_monotonic_timestamp_ms () + CARRIER_WAIT_TIME_AFTER_MTU_MS;
		}
	...
	if (success && source != BYX_CONNECTION_MTU_SOURCE_NONE)
...
void
byx_connection_commit_mtu (ByxConnection *self)
{
	ByxConnectionState state;

	g_return_if_fail (BYX_IS_CONNECTION (self));

	state = byx_connection_get_state (self);
	if (   state >= BYX_CONNECTION_STATE_CONFIG
	    && state < BYX_CONNECTION_STATE_DEACTIVATING) {
		_LOGT (LOGD_DEVICE, "mtu: commit-mtu...");
		_commit_mtu (self, BYX_CONNECTION_GET_PRIVATE (self)->ip_config_4);
	} else
		_LOGT (LOGD_DEVICE, "mtu: commit-mtu... skip due to state %s", byx_connection_state_to_str (state));
}

static void
ndisc_config_changed (NMNDisc *ndisc, const NMNDiscData *rdata, guint changed_int, ByxConnection *self)
{
	...
	if (NM_FLAGS_ANY (changed,   NM_NDISC_CONFIG_ROUTES
		...
		nm_ip6_config_reset_routes_ndisc ((NMIP6Config *) priv->ac_ip6_config.orig,
		                                  ...
		                                  byx_connection_get_route_table (self, AF_INET6, TRUE),
		                                  byx_connection_get_route_metric (self, AF_INET6),
		                                  nm_platform_check_kernel_support (byx_connection_get_platform (self),
	...
	if (changed & NM_NDISC_CONFIG_DHCP_LEVEL) {
		...
		if (priv->dhcp6.mode != NM_NDISC_DHCP_LEVEL_NONE) {
			...
			if (!dhcp6_start (self, FALSE)) {
				if (priv->dhcp6.mode == NM_NDISC_DHCP_LEVEL_MANAGED) {
					byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED,
					                         BYX_CONNECTION_STATE_REASON_DHCP_START_FAILED);
					return;
				}
			}
		}
	...
	if (changed & NM_NDISC_CONFIG_HOP_LIMIT)
		nm_platform_sysctl_set_ip6_hop_limit_safe (byx_connection_get_platform (self), byx_connection_get_ip_iface (self), rdata->hop_limit);
...
static void
ndisc_ra_timeout (NMNDisc *ndisc, ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
addrconf6_start_with_link_ready (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMUtilsIPv6IfaceId iid;
	...
	if (byx_connection_get_ip_iface_identifier (self, &iid, FALSE)) {
	...
	case NM_NDISC_NODE_TYPE_HOST:
		...
		byx_connection_ipv6_sysctl_set (self, "accept_ra", "1");
		byx_connection_ipv6_sysctl_set (self, "accept_ra_defrtr", "0");
		byx_connection_ipv6_sysctl_set (self, "accept_ra_pinfo", "0");
		byx_connection_ipv6_sysctl_set (self, "accept_ra_rtr_pref", "0");
		break;
	case NM_NDISC_NODE_TYPE_ROUTER:
		/* We're the router. */
		byx_connection_ipv6_sysctl_set (self, "forwarding", "1");
		byx_connection_activate_schedule_ip6_config_result (self);
...
ndisc_node_type (ByxConnection *self)
{
	NMConnection *connection;
	...
	if (strcmp (byx_utils_get_ip_config_method (connection, NM_TYPE_SETTING_IP6_CONFIG),
...
static gboolean
addrconf6_start (ByxConnection *self, NMSettingIP6ConfigPrivacy use_tempaddr)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection;
	NMSettingIP6Config *s_ip6 = NULL;
	...
	stable_id = _get_stable_id (self, connection, &stable_type);
	g_assert (stable_id);
	priv->ndisc = nm_lndp_ndisc_new (byx_connection_get_platform (self),
	                                 byx_connection_get_ip_ifindex (self),
	                                 byx_connection_get_ip_iface (self),
	                                 stable_type,
	                                 stable_id,
	...
	if (!nm_setting_ip_config_get_may_fail (nm_connection_get_setting_ip6_config (connection)))
		byx_connection_add_pending_action (self, NM_PENDING_ACTION_AUTOCONF6, TRUE);
...
static void
addrconf6_cleanup (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	byx_connection_remove_pending_action (self, NM_PENDING_ACTION_AUTOCONF6, FALSE);
...
static void
save_ip6_properties (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	const char *ifname = byx_connection_get_ip_iface (self);
	char *value;
	int i;
	...
	for (i = 0; i < G_N_ELEMENTS (ip6_properties_to_save); i++) {
		...
		value = nm_platform_sysctl_get (byx_connection_get_platform (self), NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, buf, ifname, ip6_properties_to_save[i])));
		if (value) {
...
static void
restore_ip6_properties (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	GHashTableIter iter;
	gpointer key, value;
...
static inline void
set_disable_ipv6 (ByxConnection *self, const char *value)
{
	/* We only touch disable_ipv6 when NM is not managing the IPv6LL address */
	if (!BYX_CONNECTION_GET_PRIVATE (self)->ipv6ll_handle)
		byx_connection_ipv6_sysctl_set (self, "disable_ipv6", value);
}

static inline void
set_nm_ipv6ll (ByxConnection *self, gboolean enable)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	int ifindex = byx_connection_get_ip_ifindex (self);
	char *value;
	...
	if (ifindex > 0) {
		...
		plerr = nm_platform_link_set_user_ipv6ll_enabled (byx_connection_get_platform (self), ifindex, enable);
		...
		if (enable) {
			...
			value = nm_platform_sysctl_get (byx_connection_get_platform (self),
			                                NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, buf, byx_connection_get_ip_iface (self), "disable_ipv6")));
			if (g_strcmp0 (value, "0") == 0)
				byx_connection_ipv6_sysctl_set (self, "disable_ipv6", "1");
			g_free (value);

			/* Ensure IPv6 is enabled */
			byx_connection_ipv6_sysctl_set (self, "disable_ipv6", "0");
		}
...
_ip6_privacy_get (ByxConnection *self)
{
	...
	ip6_privacy = _byx_utils_ascii_str_to_int64 (value, 10,
	                                            NM_SETTING_IP6_CONFIG_PRIVACY_UNKNOWN,
	...
	ip6_privacy = nm_platform_sysctl_get_int32 (byx_connection_get_platform (self), NMP_SYSCTL_PATHID_ABSOLUTE ("/proc/sys/net/ipv6/conf/default/use_tempaddr"), NM_SETTING_IP6_CONFIG_PRIVACY_UNKNOWN);
...
static NMActStageReturn
act_stage3_ip6_config_start (ByxConnection *self,
                             ...
                             ByxConnectionStateReason *out_failure_reason)
{
	...
	if (byx_connection_is_master (self) && ip6_requires_slaves (connection)) {
		/* If the master has no ready slaves, and depends on slaves for
	 ...
	 */
	nm_platform_process_events (byx_connection_get_platform (self));
	g_clear_object (&priv->ext_ip6_config_captured);
	priv->ext_ip6_config_captured = nm_ip6_config_capture (byx_connection_get_multi_index (self),
	                                                       byx_connection_get_platform (self),
	                                                       byx_connection_get_ip_ifindex (self),
	                                                       NM_SETTING_IP6_CONFIG_PRIVACY_UNKNOWN);
	...
	if (   ret != NM_ACT_STAGE_RETURN_FAILURE
		...
		byx_connection_ipv6_sysctl_set (self, "use_tempaddr", ip6_privacy_str);
	}
...
/**
 * byx_connection_activate_stage3_ip4_start:
 * @self: the device
 *
 * Try starting IPv4 configuration.
 */
gboolean
byx_connection_activate_stage3_ip4_start (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMActStageReturn ret;
	ByxConnectionStateReason failure_reason = BYX_CONNECTION_STATE_REASON_NONE;
	...
	_set_ip_state (self, AF_INET, IP_CONF);
	ret = BYX_CONNECTION_GET_CLASS (self)->act_stage3_ip4_config_start (self, &ip4_config, &failure_reason);
	if (ret == NM_ACT_STAGE_RETURN_SUCCESS) {
		if (!ip4_config)
			ip4_config = _ip4_config_new (self);
		byx_connection_activate_schedule_ip4_config_result (self, ip4_config);
...
/**
 * byx_connection_activate_stage3_ip6_start:
 * @self: the device
 *
 * Try starting IPv6 configuration.
 */
gboolean
byx_connection_activate_stage3_ip6_start (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMActStageReturn ret;
	ByxConnectionStateReason failure_reason = BYX_CONNECTION_STATE_REASON_NONE;
	...
	_set_ip_state (self, AF_INET6, IP_CONF);
	ret = BYX_CONNECTION_GET_CLASS (self)->act_stage3_ip6_config_start (self, &ip6_config, &failure_reason);
	if (ret == NM_ACT_STAGE_RETURN_SUCCESS) {
		if (!ip6_config)
 ...
 */
static void
activate_stage3_ip_config_start (ByxConnection *self)
{
	_set_ip_state (self, AF_INET, IP_WAIT);
	_set_ip_state (self, AF_INET6, IP_WAIT);
	...
	byx_connection_state_changed (self, BYX_CONNECTION_STATE_IP_CONFIG, BYX_CONNECTION_STATE_REASON_NONE);

	/* Device should be up before we can do anything with it */
	if (!nm_platform_link_is_up (byx_connection_get_platform (self), byx_connection_get_ip_ifindex (self)))
		_LOGW (LOGD_DEVICE, "interface %s not up for IP configuration", byx_connection_get_ip_iface (self));
                   ...
                   gpointer user_data)
{
	...
	case FIREWALL_STATE_WAIT_IP_CONFIG:
		...
		if (priv->ip4_state == IP_DONE || priv->ip6_state == IP_DONE)
			byx_connection_start_ip_check (self);
		break;
...
static void
fw_change_zone (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	applied_connection = byx_connection_get_applied_connection (self);
...
/*
 * byx_connection_activate_schedule_stage3_ip_config_start
 *
 * Schedule IP configuration start
 */
void
byx_connection_activate_schedule_stage3_ip_config_start (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
static NMActStageReturn
act_stage4_ip4_config_timeout (ByxConnection *self, ByxConnectionStateReason *out_failure_reason)
{
...
/*
 * byx_connection_activate_stage4_ip4_config_timeout
 *
 * Time out on retrieving the IPv4 config.
 *
 */
static void
activate_stage4_ip4_config_timeout (ByxConnection *self)
{
	NMActStageReturn ret = NM_ACT_STAGE_RETURN_FAILURE;
	ByxConnectionStateReason failure_reason = BYX_CONNECTION_STATE_REASON_NONE;

	ret = BYX_CONNECTION_GET_CLASS (self)->act_stage4_ip4_config_timeout (self, &failure_reason);
	if (ret == NM_ACT_STAGE_RETURN_POSTPONE)
		return;
	else if (ret == NM_ACT_STAGE_RETURN_FAILURE) {
		byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, failure_reason);
...
/*
 * byx_connection_activate_schedule_ip4_config_timeout
 *
 * Deal with a timeout of the IPv4 configuration
 *
 */
void
byx_connection_activate_schedule_ip4_config_timeout (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
static NMActStageReturn
act_stage4_ip6_config_timeout (ByxConnection *self, ByxConnectionStateReason *out_failure_reason)
{
 ...
 */
static void
activate_stage4_ip6_config_timeout (ByxConnection *self)
{
	NMActStageReturn ret = NM_ACT_STAGE_RETURN_FAILURE;
	ByxConnectionStateReason failure_reason = BYX_CONNECTION_STATE_REASON_NONE;

	ret = BYX_CONNECTION_GET_CLASS (self)->act_stage4_ip6_config_timeout (self, &failure_reason);
	if (ret == NM_ACT_STAGE_RETURN_POSTPONE)
		return;
	if (ret == NM_ACT_STAGE_RETURN_FAILURE) {
		byx_connection_state_changed (self, BYX_CONNECTION_STATE_FAILED, failure_reason);
...
/*
 * byx_connection_activate_schedule_ip6_config_timeout
 *
 * Deal with a timeout of the IPv6 configuration
 *
 */
void
byx_connection_activate_schedule_ip6_config_timeout (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
static gboolean
share_init (ByxConnection *self, GError **error)
{
	...
	if (nm_platform_sysctl_get_int32 (byx_connection_get_platform (self), NMP_SYSCTL_PATHID_ABSOLUTE ("/proc/sys/net/ipv4/ip_forward"), -1) == 1) {
		/* nothing to do. */
	} else if (!nm_platform_sysctl_set (byx_connection_get_platform (self), NMP_SYSCTL_PATHID_ABSOLUTE ("/proc/sys/net/ipv4/ip_forward"), "1")) {
		errsv = errno;
	...
	if (nm_platform_sysctl_get_int32 (byx_connection_get_platform (self), NMP_SYSCTL_PATHID_ABSOLUTE ("/proc/sys/net/ipv4/ip_dynaddr"), -1) == 1) {
		/* nothing to do. */
	} else if (!nm_platform_sysctl_set (byx_connection_get_platform (self), NMP_SYSCTL_PATHID_ABSOLUTE ("/proc/sys/net/ipv4/ip_dynaddr"), "1")) {
		errsv = errno;
	...
	for (iter = modules; *iter; iter++)
		byx_utils_modprobe (NULL, FALSE, *iter, NULL);
...
static gboolean
start_sharing (ByxConnection *self, NMIP4Config *config, GError **error)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMActRequest *req;
	...
	ip_iface = byx_connection_get_ip_iface (self);
	if (!ip_iface) {
		g_set_error (error, NM_UTILS_ERROR, NM_UTILS_ERROR_UNKNOWN,
	...
	req = byx_connection_get_act_request (self);
	g_assert (req);

	netmask = _byx_utils_ip4_prefix_to_netmask (ip4_addr->plen);
	byx_utils_inet4_ntop (netmask, str_mask);

	network = ip4_addr->address & netmask;
	byx_utils_inet4_ntop (network, str_addr);
...
static void
arp_cleanup (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
void
byx_connection_arp_announce (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection;
	NMSettingIPConfig *s_ip4;
	...
	hw_addr = nm_platform_link_get_address (byx_connection_get_platform (self),
	                                        byx_connection_get_ip_ifindex (self),
	                                        &hw_addr_len);
	...
	priv->acd.announcing = nm_acd_manager_new (byx_connection_get_ip_ifindex (self), hw_addr, hw_addr_len);
...
static void
activate_stage5_ip4_config_result (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMActRequest *req;
	const char *method;
	...
	ip_ifindex = byx_connection_get_ip_ifindex (self);
	if (!nm_platform_link_is_up (byx_connection_get_platform (self), ip_ifindex) && !byx_connection_sys_iface_state_is_external_or_assume (self)) {
		nm_platform_link_set_up (byx_connection_get_platform (self), ip_ifindex, NULL);
		if (!nm_platform_link_is_up (byx_connection_get_platform (self), ip_ifindex))
			_LOGW (LOGD_DEVICE, "interface %s not up for IP configuration", byx_connection_get_ip_iface (self));
	}

	if (!ip_config_merge_and_apply (self, AF_INET, TRUE)) {
		_LOGD (LOGD_DEVICE | LOGD_IP4, "Activation: Stage 5 of 5 (IPv4 Commit) failed");
		byx_connection_ip_method_failed (self, AF_INET, BYX_CONNECTION_STATE_REASON_CONFIG_FAILED);
		return;
	}
	 ...
	 */
	if (   priv->dhcp4.client
	    && byx_connection_activate_ip4_state_in_conf (self)
	    && (byx_connection_get_state (self) > BYX_CONNECTION_STATE_IP_CONFIG)) {
		nm_dispatcher_call_device (NM_DISPATCHER_ACTION_DHCP4_CHANGE,
		                           self,
		                           NULL,
	...
	byx_connection_arp_announce (self);
	byx_connection_remove_pending_action (self, NM_PENDING_ACTION_DHCP4, FALSE);
...
void
byx_connection_activate_schedule_ip4_config_result (ByxConnection *self, NMIP4Config *config)
{
	ByxConnectionPrivate *priv;
...
gboolean
byx_connection_activate_ip4_state_in_conf (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, FALSE);
	return BYX_CONNECTION_GET_PRIVATE (self)->ip4_state == IP_CONF;
}

gboolean
byx_connection_activate_ip4_state_in_wait (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, FALSE);
	return BYX_CONNECTION_GET_PRIVATE (self)->ip4_state == IP_WAIT;
}

gboolean
byx_connection_activate_ip4_state_done (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, FALSE);
	return BYX_CONNECTION_GET_PRIVATE (self)->ip4_state == IP_DONE;
}

static void
dad6_add_pending_address (ByxConnection *self,
                          NMPlatform *platform,
                          int ifindex,
 ...
 */
static NMIP6Config *
dad6_get_pending_addresses (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
activate_stage5_ip6_config_commit (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMActRequest *req;
	const char *method;
	...
	if (ip_config_merge_and_apply (self, AF_INET6, TRUE)) {
		...
		if (strcmp (method, NM_SETTING_IP6_CONFIG_METHOD_SHARED) == 0) {
			if (!nm_platform_sysctl_set (byx_connection_get_platform (self), NMP_SYSCTL_PATHID_ABSOLUTE ("/proc/sys/net/ipv6/conf/all/forwarding"), "1")) {
				errsv = errno;
				_LOGE (LOGD_SHARING, "share: error enabling IPv6 forwarding: (%d) %s", errsv, strerror (errsv));
				byx_connection_ip_method_failed (self, AF_INET6, BYX_CONNECTION_STATE_REASON_SHARED_START_FAILED);
			}
		}
		...
		byx_connection_ip_method_failed (self, AF_INET6, BYX_CONNECTION_STATE_REASON_CONFIG_FAILED);
	}
}

void
byx_connection_activate_schedule_ip6_config_result (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
gboolean
byx_connection_activate_ip6_state_in_conf (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, FALSE);
	return BYX_CONNECTION_GET_PRIVATE (self)->ip6_state == IP_CONF;
}

gboolean
byx_connection_activate_ip6_state_in_wait (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, FALSE);
	return BYX_CONNECTION_GET_PRIVATE (self)->ip6_state == IP_WAIT;
}

gboolean
byx_connection_activate_ip6_state_done (ByxConnection *self)
{
	g_return_val_if_fail (self != NULL, FALSE);
	return BYX_CONNECTION_GET_PRIVATE (self)->ip6_state == IP_DONE;
}

/*****************************************************************************/

static void
act_request_set (ByxConnection *self, NMActRequest *act_request)
{
	ByxConnectionPrivate *priv;
	...
	if (act_request) {
		...
		case NM_ACTIVATION_TYPE_ASSUME:
			if (priv->sys_iface_state == BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL)
				byx_connection_sys_iface_state_set (self, BYX_CONNECTION_SYS_IFACE_STATE_ASSUME);
			break;
		case NM_ACTIVATION_TYPE_MANAGED:
			if (NM_IN_SET_TYPED (ByxConnectionSysIfaceState,
			                     priv->sys_iface_state,
			                     BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL,
			                     BYX_CONNECTION_SYS_IFACE_STATE_ASSUME))
				byx_connection_sys_iface_state_set (self, BYX_CONNECTION_SYS_IFACE_STATE_MANAGED);
			break;
		}
	}
}
...
static void
dnsmasq_cleanup (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
_update_ip4_address (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	const NMPlatformIP4Address *address;
...
gboolean
byx_connection_is_nm_owned (ByxConnection *self)
{
	return BYX_CONNECTION_GET_PRIVATE (self)->nm_owned;
}
...
delete_on_deactivate_link_delete (gpointer user_data)
{
	...
	ByxConnection *self = data->device;
	...
	if (data->device) {
		...
		if (!byx_connection_unrealize (data->device, TRUE, &error))
			_LOGD (LOGD_DEVICE, "delete_on_deactivate: unrealizing %d failed (%s)", data->ifindex, error->message);
	} else if (data->ifindex > 0)
		nm_platform_link_delete (byx_connection_get_platform (self), data->ifindex);
...
static void
delete_on_deactivate_unschedule (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
delete_on_deactivate_check_and_schedule (ByxConnection *self, int ifindex)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (!byx_connection_is_software (self) || !byx_connection_is_real (self))
		return;
	if (byx_connection_get_state (self) == BYX_CONNECTION_STATE_UNMANAGED)
		return;
	if (byx_connection_get_state (self) == BYX_CONNECTION_STATE_UNAVAILABLE)
		return;
...
static void
_cleanup_ip_pre (ByxConnection *self, int addr_family, CleanupType cleanup_type)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	const gboolean IS_IPv4 = (addr_family == AF_INET);
...
gboolean
_byx_connection_hash_check_invalid_keys (GHashTable *hash, const char *setting_name,
                                    GError **error, const char **whitelist)
{
	...
	if (error) {
		...
		while (g_hash_table_iter_next (&iter, (gpointer *) &k, NULL)) {
			if (byx_utils_strv_find_first ((char **) whitelist, -1, k) < 0) {
				first_invalid_key = k;
				break;
			}
		}
		if (setting_name) {
			g_set_error (error,
			             BYX_CONNECTION_ERROR,
			             BYX_CONNECTION_ERROR_INCOMPATIBLE_CONNECTION,
...
void
byx_connection_reactivate_ip4_config (ByxConnection *self,
...
void
byx_connection_reactivate_ip6_config (ByxConnection *self,
                    ...
                    GHashTable *diffs, GError **error)
{
	if (nm_streq (setting_name, NM_SETTING_CONNECTION_SETTING_NAME)) {
		 ...
		 * settings-connection. */
		return byx_connection_hash_check_invalid_keys (diffs,
		...
		if (g_hash_table_contains (diffs, NM_SETTING_IP_CONFIG_ROUTE_TABLE)) {
			 ...
			 *
			 * Note how byx_connection_get_route_table() caches the value for the duration of the
			 * activation. */
			g_set_error (error,
			             BYX_CONNECTION_ERROR,
			             BYX_CONNECTION_ERROR_INCOMPATIBLE_CONNECTION,
...
static void
reapply_connection (ByxConnection *self, NMConnection *con_old, NMConnection *con_new)
{
                              ...
                              GError **error)
{
	ByxConnectionClass *klass = BYX_CONNECTION_GET_CLASS (self);
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *applied = byx_connection_get_applied_connection (self);
	...
	if (   version_id != 0
		...
		g_set_error_literal (error,
		                     BYX_CONNECTION_ERROR,
		                     BYX_CONNECTION_ERROR_VERSION_ID_MISMATCH,
	...
	byx_connection_update_firewall_zone (self);
	byx_connection_update_metered (self);
...
gboolean
byx_connection_reapply (ByxConnection *self,
                   NMConnection *connection,
                   GError **error)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), FALSE);
...
static void
impl_device_reapply (ByxDBusObject *obj,
                     ...
                     GVariant *parameters)
{
	ByxConnection *self = BYX_CONNECTION (obj);
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMSettingsConnection *settings_connection;
	NMConnection *connection = NULL;
	GError *error = NULL;
	...
	g_signal_emit (self, signals[AUTH_REQUEST], 0,
	               invocation,
	               byx_connection_get_applied_connection (self),
...
static void
get_applied_connection_cb (ByxConnection *self,
                           GDBusMethodInvocation *context,
                           NMAuthSubject *subject,
                           GError *error,
...
static void
impl_device_get_applied_connection (ByxDBusObject *obj,
                                    const ByxDBusInterfaceInfoExtended *interface_info,
                                    const NMDBusMethodInfoExtended *method_info,
...
static gboolean
_rt6_temporary_not_available_set (ByxConnection *self,
...
static void
disconnect_cb (ByxConnection *self,
               GDBusMethodInvocation *context,
               NMAuthSubject *subject,
               GError *error,
               gpointer user_data)
...
static void
_clear_queued_act_request (ByxConnectionPrivate *priv)
{
	if (priv->queued_act_request) {
...
static void
impl_device_disconnect (ByxDBusObject *obj,
                        const ByxDBusInterfaceInfoExtended *interface_info,
                        const NMDBusMethodInfoExtended *method_info,
                        GDBusConnection *dbus_connection,
                        const char *sender,
...
static void
impl_device_delete (ByxDBusObject *obj,
                    const ByxDBusInterfaceInfoExtended *interface_info,
                    const NMDBusMethodInfoExtended *method_info,
                    GDBusConnection *connection,
                    const char *sender,
                    ...
                    GVariant *parameters)
{
	...
	if (   !byx_connection_is_software (self)
	    || !byx_connection_is_real (self)) {
		g_dbus_method_invocation_return_error_literal (invocation,
		                                               BYX_CONNECTION_ERROR,
		                                               BYX_CONNECTION_ERROR_NOT_SOFTWARE,
...
static void
_device_activate (ByxConnection *self, NMActRequest *req)
{
	NMConnection *connection;

	g_return_if_fail (BYX_IS_CONNECTION (self));
	g_return_if_fail (NM_IS_ACT_REQUEST (req));
	nm_assert (byx_connection_is_real (self));
	...
	byx_connection_activate_schedule_stage1_device_prepare (self);
}

static void
_carrier_wait_check_queued_act_request (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static gboolean
_carrier_wait_check_act_request_must_queue (ByxConnection *self, NMActRequest *req)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection;
	...
	if (!byx_connection_check_connection_available (self, connection, BYX_CONNECTION_CHECK_CON_AVAILABLE_ALL, NULL)) {
	...
	if (byx_connection_check_connection_available (self, connection, BYX_CONNECTION_CHECK_CON_AVAILABLE_ALL & ~_BYX_CONNECTION_CHECK_CON_AVAILABLE_FOR_USER_REQUEST_WAITING_CARRIER, NULL)) {
...
void
byx_connection_disconnect_active_connection (NMActiveConnection *active)
{
	ByxConnection *self;
	ByxConnectionPrivate *priv;
	...
	if (NM_ACTIVE_CONNECTION (priv->act_request.obj) == active) {
		if (priv->state < BYX_CONNECTION_STATE_DEACTIVATING) {
			byx_connection_state_changed (self,
			                         BYX_CONNECTION_STATE_DEACTIVATING,
			                         BYX_CONNECTION_STATE_REASON_NEW_ACTIVATION);
		} else {
...
void
byx_connection_queue_activation (ByxConnection *self, NMActRequest *req)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	gboolean must_queue;
...
/*
 * byx_connection_is_activating
 *
 * Return whether or not the device is currently activating itself.
 *
 */
gboolean
byx_connection_is_activating (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	ByxConnectionState state;
	...
	state = byx_connection_get_state (self);
	if (state >= BYX_CONNECTION_STATE_PREPARE && state <= BYX_CONNECTION_STATE_SECONDARIES)
		return TRUE;
...
NMDhcp4Config *
byx_connection_get_dhcp4_config (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->dhcp4.config;
}

NMIP4Config *
byx_connection_get_ip4_config (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->ip_config_4;
}

static gboolean
byx_connection_set_ip_config (ByxConnection *self,
                         int addr_family,
                         ...
                         GPtrArray *ip4_dev_route_blacklist)
{
	...
	nm_assert (   !new_config
	           || (   new_config
	               && ({
	                    int ip_ifindex = byx_connection_get_ip_ifindex (self);
	...
	if (commit && new_config) {
		...
		if (IS_IPv4) {
			success = nm_ip4_config_commit (NM_IP4_CONFIG (new_config),
			                                byx_connection_get_platform (self),
			                                byx_connection_get_route_table (self, addr_family, FALSE)
			                                  ? NM_IP_ROUTE_TABLE_SYNC_MODE_FULL
			                                  : NM_IP_ROUTE_TABLE_SYNC_MODE_MAIN);
			nm_platform_ip4_dev_route_blacklist_set (byx_connection_get_platform (self),
...
void
byx_connection_replace_vpn4_config (ByxConnection *self, NMIP4Config *old, NMIP4Config *config)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);

	nm_assert (!old || NM_IS_IP4_CONFIG (old));
	nm_assert (!config || NM_IS_IP4_CONFIG (config));
	nm_assert (!old || nm_ip4_config_get_ifindex (old) == byx_connection_get_ip_ifindex (self));
	nm_assert (!config || nm_ip4_config_get_ifindex (config) == byx_connection_get_ip_ifindex (self));
...
void
byx_connection_set_wwan_ip4_config (ByxConnection *self, NMIP4Config *config)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
void
byx_connection_replace_vpn6_config (ByxConnection *self, NMIP6Config *old, NMIP6Config *config)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);

	nm_assert (!old || NM_IS_IP6_CONFIG (old));
	nm_assert (!config || NM_IS_IP6_CONFIG (config));
	nm_assert (!old || nm_ip6_config_get_ifindex (old) == byx_connection_get_ip_ifindex (self));
	nm_assert (!config || nm_ip6_config_get_ifindex (config) == byx_connection_get_ip_ifindex (self));
...
void
byx_connection_set_wwan_ip6_config (ByxConnection *self, NMIP6Config *config)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
NMDhcp6Config *
byx_connection_get_dhcp6_config (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->dhcp6.config;
}

NMIP6Config *
byx_connection_get_ip6_config (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->ip_config_6;
}

/*****************************************************************************/

static void
dispatcher_cleanup (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (priv->dispatcher.call_id) {
		...
		priv->dispatcher.post_state = BYX_CONNECTION_STATE_UNKNOWN;
		priv->dispatcher.post_state_reason = BYX_CONNECTION_STATE_REASON_NONE;
	}
}
...
dispatcher_complete_proceed_state (guint call_id, gpointer user_data)
{
	...
	priv->dispatcher.call_id = 0;
	byx_connection_queue_state (self, priv->dispatcher.post_state,
...
static void
ip_check_pre_up (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	priv->dispatcher.post_state = BYX_CONNECTION_STATE_SECONDARIES;
	priv->dispatcher.post_state_reason = BYX_CONNECTION_STATE_REASON_NONE;
...
static void
ip_check_gw_ping_cleanup (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (priv->gw_ping.pid) {
		byx_utils_kill_child_async (priv->gw_ping.pid, SIGTERM, priv->gw_ping.log_domain, "ping", 1000, NULL, NULL);
		priv->gw_ping.pid = 0;
	}
...
static void
byx_connection_start_ip_check (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMConnection *connection;
	NMSettingConnection *s_con;
	...
	if (timeout) {
		...
		if (priv->ip_config_4 && priv->ip4_state == IP_DONE) {
			...
			if (gw) {
				byx_utils_inet4_ntop (NMP_OBJECT_CAST_IP4_ROUTE (gw)->gateway, buf);
				ping_binary = byx_utils_find_helper ("ping", "/usr/bin/ping", NULL);
				log_domain = LOGD_IP4;
			}
		} else if (priv->ip_config_6 && priv->ip6_state == IP_DONE) {
			gw = nm_ip6_config_best_default_route_get (priv->ip_config_6);
			if (gw) {
				byx_utils_inet6_ntop (&NMP_OBJECT_CAST_IP6_ROUTE (gw)->gateway, buf);
				ping_binary = byx_utils_find_helper ("ping6", "/usr/bin/ping6", NULL);
				log_domain = LOGD_IP6;
			}
		}
	}
...
static gboolean
byx_connection_is_up (ByxConnection *self)
{
	int ifindex;
	...
	ifindex = byx_connection_get_ip_ifindex (self);
	return ifindex > 0 ? nm_platform_link_is_up (byx_connection_get_platform (self), ifindex) : TRUE;
}
...
gboolean
byx_connection_bring_up (ByxConnection *self, gboolean block, gboolean *no_firmware)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (ifindex <= 0) {
		...
		if (!nm_platform_link_set_up (byx_connection_get_platform (self), ifindex, no_firmware))
			return FALSE;
	}
	...
	device_is_up = byx_connection_is_up (self);
	if (block && !device_is_up) {
		gint64 wait_until = byx_utils_get_monotonic_timestamp_us () + 10000 /* microseconds */;

		do {
			g_usleep (200);
			if (!nm_platform_link_refresh (byx_connection_get_platform (self), ifindex))
				return FALSE;
			device_is_up = byx_connection_is_up (self);
		} while (!device_is_up && byx_utils_get_monotonic_timestamp_us () < wait_until);
	}
	...
	capabilities = 0;
	if (BYX_CONNECTION_GET_CLASS (self)->get_generic_capabilities)
		capabilities |= BYX_CONNECTION_GET_CLASS (self)->get_generic_capabilities (self);
	_add_capabilities (self, capabilities);
...
void
byx_connection_take_down (ByxConnection *self, gboolean block)
{
	int ifindex;
	...
	if (!nm_platform_link_set_down (byx_connection_get_platform (self), ifindex))
		return;
...
void
byx_connection_set_firmware_missing (ByxConnection *self, gboolean new_missing)
{
	ByxConnectionPrivate *priv;
...
gboolean
byx_connection_get_firmware_missing (ByxConnection *self)
{
	return BYX_CONNECTION_GET_PRIVATE (self)->firmware_missing;
}

static void
intersect_ext_config (ByxConnection *self, AppliedConfig *config)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMIPConfig *ext;
	guint32 penalty;
...
static gboolean
update_ext_ip_config (ByxConnection *self, int addr_family, gboolean intersect_configs)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	int ifindex;
	GSList *iter;
	...
	if (addr_family == AF_INET) {
		...
		g_clear_object (&priv->ext_ip_config_4);
		priv->ext_ip_config_4 = nm_ip4_config_capture (byx_connection_get_multi_index (self),
		                                              byx_connection_get_platform (self),
		                                              ifindex);
...
static void
update_ip_config (ByxConnection *self, int addr_family)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
void
byx_connection_capture_initial_config (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static gboolean
queued_ip_config_change (ByxConnection *self, int addr_family)
{
	ByxConnectionPrivate *priv;
	const gboolean IS_IPv4 = (addr_family == AF_INET);
	...
	if (!IS_IPv4) {
		...
		if (   priv->state > BYX_CONNECTION_STATE_DISCONNECTED
		    && priv->state < BYX_CONNECTION_STATE_DEACTIVATING
		    && !byx_connection_sys_iface_state_is_external (self)
		    && (platform = byx_connection_get_platform (self))
                    ...
                    ByxConnection *self)
{
	...
	if (byx_connection_get_ip_ifindex (self) != ifindex)
		return;
...
_unmanaged_flags2str (NMUnmanagedFlags flags, NMUnmanagedFlags mask, char *buf, gsize len)
{
	...
	if (buf2[0]) {
		...
		while (TRUE) {
			...
			byx_utils_strbuf_append_c (&b, &len, '!');
			byx_utils_strbuf_append_str (&b, &len, tmp);
			if (!tmp2)
				break;
 ...
 */
gboolean
byx_connection_get_managed (ByxConnection *self, gboolean for_user_request)
{
	ByxConnectionPrivate *priv;
...
/**
 * byx_connection_get_unmanaged_mask:
 * @self: the #ByxConnection
 ...
 */
NMUnmanagedFlags
byx_connection_get_unmanaged_mask (ByxConnection *self, NMUnmanagedFlags flag)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NM_UNMANAGED_NONE);
	g_return_val_if_fail (flag != NM_UNMANAGED_NONE, NM_UNMANAGED_NONE);

	return BYX_CONNECTION_GET_PRIVATE (self)->unmanaged_mask & flag;
}

/**
 * byx_connection_get_unmanaged_flags:
 * @self: the #ByxConnection
 * @flag: the unmanaged flags to check.
 *
 ...
 */
NMUnmanagedFlags
byx_connection_get_unmanaged_flags (ByxConnection *self, NMUnmanagedFlags flag)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NM_UNMANAGED_NONE);
	g_return_val_if_fail (flag != NM_UNMANAGED_NONE, NM_UNMANAGED_NONE);

	return BYX_CONNECTION_GET_PRIVATE (self)->unmanaged_flags & flag;
}

/**
 * _set_unmanaged_flags:
 * @self: the #ByxConnection instance
 ...
 * @reason: the device state reason passed to byx_connection_state_changed() if
 ...
 **/
static void
_set_unmanaged_flags (ByxConnection *self,
                      ...
                      ByxConnectionStateReason reason)
{
	...
	if (   NM_FLAGS_HAS (priv->unmanaged_flags, NM_UNMANAGED_PLATFORM_INIT)
		...
		if (!NM_FLAGS_HAS (flags, NM_UNMANAGED_USER_SETTINGS)) {
			...
			unmanaged = byx_connection_spec_match_list (self,
			                                       nm_settings_get_unmanaged_specs (BYX_CONNECTION_GET_PRIVATE (self)->settings));
			byx_connection_set_unmanaged_flags (self,
		...
		if (!priv->pending_actions) {
			...
			had_pending_actions = byx_connection_has_pending_action (self);
		}
	}
	...
	transition_state =    allow_state_transition
	                   && was_managed != byx_connection_get_managed (self, FALSE)
	                   && (   was_managed
	                       || (   !was_managed
	                           && byx_connection_get_state (self) == BYX_CONNECTION_STATE_UNMANAGED));
	...
	if (transition_state) {
		new_state = was_managed ? BYX_CONNECTION_STATE_UNMANAGED : BYX_CONNECTION_STATE_UNAVAILABLE;
		if (now)
			byx_connection_state_changed (self, new_state, reason);
		else
			byx_connection_queue_state (self, new_state, reason);
	}
}
 ...
 **/
void
byx_connection_set_unmanaged_flags (ByxConnection *self,
                               NMUnmanagedFlags flags,
                               NMUnmanFlagOp set_op)
{
	_set_unmanaged_flags (self, flags, set_op, FALSE, FALSE, BYX_CONNECTION_STATE_REASON_NONE);
}

/**
 * byx_connection_set_unmanaged_by_flags:
 * @self: the #ByxConnection instance
 * @flags: which #NMUnmanagedFlags to set.
 * @set_op: whether to set/clear/forget the flags. You can also pass
 *   boolean values %TRUE and %FALSE, which mean %NM_UNMAN_FLAG_OP_SET_UNMANAGED
 ...
 **/
void
byx_connection_set_unmanaged_by_flags (ByxConnection *self,
                                  NMUnmanagedFlags flags,
                                  NMUnmanFlagOp set_op,
                                  ByxConnectionStateReason reason)
{
...
void
byx_connection_set_unmanaged_by_flags_queue (ByxConnection *self,
                                        NMUnmanagedFlags flags,
                                        NMUnmanFlagOp set_op,
                                        ByxConnectionStateReason reason)
{
...
void
byx_connection_set_unmanaged_by_user_settings (ByxConnection *self)
{
	gboolean unmanaged;
	...
	byx_connection_set_unmanaged_by_flags (self,
	                                  ...
	                                  !!unmanaged,
	                                  unmanaged
	                                      ? BYX_CONNECTION_STATE_REASON_NOW_UNMANAGED
	                                      : BYX_CONNECTION_STATE_REASON_NOW_MANAGED);
}

void
byx_connection_set_unmanaged_by_user_udev (ByxConnection *self)
{
	int ifindex;
	...
	if (   ifindex <= 0
	    || !nm_platform_link_get_unmanaged (byx_connection_get_platform (self), ifindex, &platform_unmanaged))
		return;
...
void
byx_connection_set_unmanaged_by_user_conf (ByxConnection *self)
{
	gboolean value;
	NMUnmanFlagOp set_op;
...
void
byx_connection_set_unmanaged_by_quitting (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	gboolean need_deactivate = byx_connection_is_activating (self) ||
	                           priv->state == BYX_CONNECTION_STATE_ACTIVATED;

	/* It's OK to block here because we're quitting */
	if (need_deactivate)
		_set_state_full (self, BYX_CONNECTION_STATE_DEACTIVATING, BYX_CONNECTION_STATE_REASON_NOW_UNMANAGED, TRUE);

	byx_connection_set_unmanaged_by_flags (self,
	                                  NM_UNMANAGED_QUITTING,
	                                  TRUE,
	                                  need_deactivate ? BYX_CONNECTION_STATE_REASON_REMOVED
	                                                  : BYX_CONNECTION_STATE_REASON_NOW_UNMANAGED);
}
...
void
byx_connection_set_dhcp_anycast_address (ByxConnection *self, const char *addr)
{
	ByxConnectionPrivate *priv;

	g_return_if_fail (BYX_IS_CONNECTION (self));
	g_return_if_fail (!addr || byx_utils_hwaddr_valid (addr, ETH_ALEN));
...
void
byx_connection_reapply_settings_immediately (ByxConnection *self)
{
	NMConnection *applied_connection;
	NMSettingsConnection *settings_connection;
	ByxConnectionState state;
	...
	state = byx_connection_get_state (self);
	if (   state <= BYX_CONNECTION_STATE_DISCONNECTED
	    || state > BYX_CONNECTION_STATE_ACTIVATED)
		return;
...
void
byx_connection_update_firewall_zone (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
void
byx_connection_update_metered (ByxConnection *self)
{
...
static gboolean
_byx_connection_check_connection_available (ByxConnection *self,
                                       NMConnection *connection,
                                       ...
                                       const char *specific_object)
{
	...
	if (!byx_connection_is_real (self)) {
		if (byx_connection_is_software (self))
			return byx_connection_check_connection_compatible (self, connection);
		return FALSE;
	}
	...
	if (!byx_connection_check_connection_compatible (self, connection))
		return FALSE;

	return BYX_CONNECTION_GET_CLASS (self)->check_connection_available (self, connection, flags, specific_object);
}

/**
 * byx_connection_check_connection_available():
 * @self: the #ByxConnection
 ...
 */
gboolean
byx_connection_check_connection_available (ByxConnection *self,
                                      NMConnection *connection,
                                      ByxConnectionCheckConAvailableFlags flags,
                                      const char *specific_object)
{
...
#if NM_MORE_ASSERTS >= 2
	{
		...
		ByxConnectionCheckConAvailableFlags i, j, k;
		gboolean available_all[BYX_CONNECTION_CHECK_CON_AVAILABLE_ALL + 1] = { FALSE };

		for (i = 0; i <= BYX_CONNECTION_CHECK_CON_AVAILABLE_ALL; i++)
			available_all[i] = _byx_connection_check_connection_available (self, connection, i, specific_object);
...
static gboolean
available_connections_del_all (ByxConnection *self)
{
...
static gboolean
available_connections_add (ByxConnection *self, NMConnection *connection)
{
	return g_hash_table_add (self->_priv->available_connections, g_object_ref (connection));
}

static gboolean
available_connections_del (ByxConnection *self, NMConnection *connection)
{
	return g_hash_table_remove (self->_priv->available_connections, connection);
}

static gboolean
check_connection_available (ByxConnection *self,
                            NMConnection *connection,
                            ByxConnectionCheckConAvailableFlags flags,
                            const char *specific_object)
{
...
void
byx_connection_recheck_available_connections (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
	...
	for (i = 0; connections[i]; i++) {
		...
		if (byx_connection_check_connection_available (self,
		                                          connection,
		                                          BYX_CONNECTION_CHECK_CON_AVAILABLE_NONE,
		                                          NULL)) {
...
/**
 * byx_connection_get_best_connection:
 * @self: the #ByxConnection
 ...
 */
NMSettingsConnection *
byx_connection_get_best_connection (ByxConnection *self,
                               const char *specific_object,
                               GError **error)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	while (g_hash_table_iter_next (&iter, (gpointer) &candidate, NULL)) {
		...
		if (    specific_object /* << Optimization: we know that the connection is available without @specific_object.  */
		    && !byx_connection_check_connection_available (self,
		                                              NM_CONNECTION (candidate),
		                                              _BYX_CONNECTION_CHECK_CON_AVAILABLE_FOR_USER_REQUEST,
		                                              specific_object))
			continue;
	...
	if (!connection) {
		g_set_error (error, BYX_MANAGER_ERROR, BYX_MANAGER_ERROR_UNKNOWN_CONNECTION,
...
static void
cp_connection_added_or_updated (ByxConnection *self, NMConnection *connection)
{
	gboolean changed;
...
gboolean
byx_connection_supports_vlans (ByxConnection *self)
{
	return nm_platform_link_supports_vlans (byx_connection_get_platform (self), byx_connection_get_ifindex (self));
}

/**
 * byx_connection_add_pending_action():
 * @self: the #ByxConnection to add the pending action to
 ...
 */
gboolean
byx_connection_add_pending_action (ByxConnection *self, const char *action, gboolean assert_not_yet_pending)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	GSList *iter;
	guint count = 0;
...
/**
 * byx_connection_remove_pending_action():
 * @self: the #ByxConnection to remove the pending action from
 ...
 * return %FALSE.
 *
 * Removes a pending action previously added by byx_connection_add_pending_action().
 *
 * Returns: whether the @action was pending and is now removed.
 */
gboolean
byx_connection_remove_pending_action (ByxConnection *self, const char *action, gboolean assert_is_pending)
{
	ByxConnectionPrivate *priv;
	GSList *iter, *next;
	guint count = 0;
...
gboolean
byx_connection_has_pending_action (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
_cancel_activation (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
static void
_cleanup_generic_pre (ByxConnection *self, CleanupType cleanup_type)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	if (cleanup_type != CLEANUP_TYPE_KEEP) {
		byx_manager_device_route_metric_clear (byx_manager_get (),
		                                      byx_connection_get_ip_ifindex (self));
	}
...
static void
_cleanup_generic_post (ByxConnection *self, CleanupType cleanup_type)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	/* We no longer accept the delegations. byx_connection_set_ip_config(NULL)
	 * above disables them. */
	...
	if (cleanup_type == CLEANUP_TYPE_DECONFIGURE) {
		...
		delete_on_deactivate_check_and_schedule (self, byx_connection_get_ip_ifindex (self));
	}
...
/*
 * byx_connection_cleanup
 *
 * Remove a device's routing table entries and IP addresses.
 *
 */
static void
byx_connection_cleanup (ByxConnection *self, ByxConnectionStateReason reason, CleanupType cleanup_type)
{
	ByxConnectionPrivate *priv;
	int ifindex;
	...
	if (reason == BYX_CONNECTION_STATE_REASON_NOW_MANAGED)
	...
	if (cleanup_type == CLEANUP_TYPE_DECONFIGURE) {
		...
		byx_connection_ipv6_sysctl_set (self, "accept_ra", "0");
		byx_connection_ipv6_sysctl_set (self, "use_tempaddr", "0");
	}

	/* Call device type-specific deactivation */
	if (BYX_CONNECTION_GET_CLASS (self)->deactivate)
		BYX_CONNECTION_GET_CLASS (self)->deactivate (self);

	ifindex = byx_connection_get_ip_ifindex (self);

	if (cleanup_type == CLEANUP_TYPE_DECONFIGURE) {
		/* master: release slaves */
		byx_connection_master_release_slaves (self);
	...
	if (ifindex > 0)
		nm_platform_ip4_dev_route_blacklist_set (byx_connection_get_platform (self), ifindex, NULL);
	...
	if (byx_connection_get_state (self) <= BYX_CONNECTION_STATE_UNMANAGED)
		byx_connection_hw_addr_reset (self, "unmanage");
	else {
		...
		BYX_CONNECTION_GET_CLASS (self)->deactivate_reset_hw_addr (self);
	}
	...
	if (priv->mtu_initial || priv->ip6_mtu_initial) {
		...
		if (   ifindex > 0
			...
			if (priv->mtu_initial) {
				nm_platform_link_set_mtu (byx_connection_get_platform (self), ifindex, priv->mtu_initial);
				priv->carrier_wait_until_ms = byx_utils_get_monotonic_timestamp_ms () + CARRIER_WAIT_TIME_AFTER_MTU_MS;
			}
...
static void
deactivate_reset_hw_addr (ByxConnection *self)
{
	byx_connection_hw_addr_reset (self, "deactivate");
}

static char *
find_dhcp4_address (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	nm_ip_config_iter_ip4_address_for_each (&ipconf_iter, priv->ip_config_4, &a) {
		if (a->addr_source == NM_IP_CONFIG_SOURCE_DHCP)
			return g_strdup (byx_utils_inet4_ntop (a->address, NULL));
	}
	return NULL;
}

void
byx_connection_spawn_iface_helper (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	g_ptr_array_add (argv, g_strdup (byx_logging_level_to_string ()));

	g_ptr_array_add (argv, g_strdup ("--log-domains"));
	g_ptr_array_add (argv, g_strdup (byx_logging_domains_to_string ()));
	...
	if (g_strcmp0 (method, NM_SETTING_IP4_CONFIG_METHOD_AUTO) == 0) {
		...
		g_ptr_array_add (argv, g_strdup_printf ("%u", byx_connection_get_route_metric (self, AF_INET)));
		...
		if (priv->dhcp4.client) {
			...
			if (client_id) {
				...
				g_ptr_array_add (argv,
				                 _byx_utils_bin2str (g_bytes_get_data (client_id, NULL),
	...
	if (g_strcmp0 (method, NM_SETTING_IP6_CONFIG_METHOD_AUTO) == 0) {
		...
		g_ptr_array_add (argv, g_strdup_printf ("%u", byx_connection_get_route_metric (self, AF_INET6)));
	...
	if (configured) {
		...
		if (byx_logging_enabled (LOGL_DEBUG, LOGD_DEVICE)) {
			char *tmp;
...
static gboolean
ip_config_valid (ByxConnectionState state)
{
	return (state == BYX_CONNECTION_STATE_UNMANAGED) ||
	        (state >= BYX_CONNECTION_STATE_IP_CHECK &&
	         state <= BYX_CONNECTION_STATE_DEACTIVATING);
}

static void
notify_ip_properties (ByxConnection *self)
{
	_notify (self, PROP_IP_IFACE);
...
static void
ip6_managed_setup (ByxConnection *self)
{
	set_nm_ipv6ll (self, TRUE);
	set_disable_ipv6 (self, "1");
	byx_connection_ipv6_sysctl_set (self, "accept_ra_defrtr", "0");
	...
	byx_connection_ipv6_sysctl_set (self, "accept_ra_rtr_pref", "0");
	byx_connection_ipv6_sysctl_set (self, "use_tempaddr", "0");
	byx_connection_ipv6_sysctl_set (self, "forwarding", "0");
}

static void
deactivate_async_ready (ByxConnection *self,
                        GAsyncResult *res,
                        gpointer user_data)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	ByxConnectionStateReason reason = GPOINTER_TO_UINT (user_data);
	GError *error = NULL;

	BYX_CONNECTION_GET_CLASS (self)->deactivate_async_finish (self, res, &error);
	...
	if (   g_error_matches (error, G_IO_ERROR, G_IO_ERROR_CANCELLED)
		...
		byx_connection_queue_state (self, BYX_CONNECTION_STATE_DISCONNECTED, reason);
	}
...
deactivate_dispatcher_complete (guint call_id, gpointer user_data)
{
	...
	g_return_if_fail (call_id == priv->dispatcher.call_id);
	g_return_if_fail (priv->dispatcher.post_state == BYX_CONNECTION_STATE_DISCONNECTED);
	...
	if (   BYX_CONNECTION_GET_CLASS (self)->deactivate_async
	    && BYX_CONNECTION_GET_CLASS (self)->deactivate_async_finish) {
		priv->deactivating_cancellable = g_cancellable_new ();
		BYX_CONNECTION_GET_CLASS (self)->deactivate_async (self,
...
static void
_set_state_full (ByxConnection *self,
                 ByxConnectionState state,
                 ByxConnectionStateReason reason,
                 gboolean quitting)
{
	 ...
	 */
	if (   (priv->state == state)
	    && (   state != BYX_CONNECTION_STATE_UNAVAILABLE
	        || !priv->firmware_missing)) {
		_LOGD (LOGD_DEVICE, "state change: %s -> %s (reason '%s', sys-iface-state: '%s'%s)",
		       byx_connection_state_to_str (old_state),
		       byx_connection_state_to_str (state),
		       reason_to_string (reason),
		       _sys_iface_state_to_str (priv->sys_iface_state),
	...
	if (   state >  BYX_CONNECTION_STATE_UNMANAGED
	    && state <= BYX_CONNECTION_STATE_ACTIVATED
	    && byx_connection_state_reason_check (reason) == BYX_CONNECTION_STATE_REASON_NOW_MANAGED
	    && NM_IN_SET_TYPED (ByxConnectionSysIfaceState,
	                        priv->sys_iface_state,
	                        BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL,
	                        BYX_CONNECTION_SYS_IFACE_STATE_ASSUME))
		byx_connection_sys_iface_state_set (self, BYX_CONNECTION_SYS_IFACE_STATE_MANAGED);
	...
	if (   state <= BYX_CONNECTION_STATE_DISCONNECTED
	    || state >= BYX_CONNECTION_STATE_ACTIVATED)
		priv->auth_retries = BYX_CONNECTION_AUTH_RETRIES_UNSET;
	...
	if (state <= BYX_CONNECTION_STATE_UNAVAILABLE) {
		if (available_connections_del_all (self))
			_notify (self, PROP_AVAILABLE_CONNECTIONS);
		if (old_state > BYX_CONNECTION_STATE_UNAVAILABLE)
			_clear_queued_act_request (priv);
	}

	/* Update the available connections list when a device first becomes available */
	if (state >= BYX_CONNECTION_STATE_DISCONNECTED && old_state < BYX_CONNECTION_STATE_DISCONNECTED)
		byx_connection_recheck_available_connections (self);

	if (state <= BYX_CONNECTION_STATE_DISCONNECTED || state > BYX_CONNECTION_STATE_DEACTIVATING) {
	 ...
	 */
	switch (state) {
	case BYX_CONNECTION_STATE_UNMANAGED:
		byx_connection_set_firmware_missing (self, FALSE);
		if (old_state > BYX_CONNECTION_STATE_UNMANAGED) {
			if (priv->sys_iface_state != BYX_CONNECTION_SYS_IFACE_STATE_MANAGED) {
				byx_connection_cleanup (self, reason,
				                   priv->sys_iface_state == BYX_CONNECTION_SYS_IFACE_STATE_REMOVED
				                       ? CLEANUP_TYPE_REMOVED
				                       : CLEANUP_TYPE_KEEP);
			} else {
				/* Clean up if the device is now unmanaged but was activated */
				if (byx_connection_get_act_request (self))
					byx_connection_cleanup (self, reason, CLEANUP_TYPE_DECONFIGURE);
				byx_connection_take_down (self, TRUE);
				byx_connection_hw_addr_reset (self, "unmanage");
				set_nm_ipv6ll (self, FALSE);
				restore_ip6_properties (self);
				break;
		...
		break;
	case BYX_CONNECTION_STATE_UNAVAILABLE:
		if (old_state == BYX_CONNECTION_STATE_UNMANAGED) {
		...
		if (priv->sys_iface_state == BYX_CONNECTION_SYS_IFACE_STATE_MANAGED) {
			if (old_state == BYX_CONNECTION_STATE_UNMANAGED || priv->firmware_missing) {
				if (!byx_connection_bring_up (self, TRUE, &no_firmware) && no_firmware)
					_LOGW (LOGD_PLATFORM, "firmware may be missing.");
				byx_connection_set_firmware_missing (self, no_firmware ? TRUE : FALSE);
			}
	...
	case BYX_CONNECTION_STATE_DISCONNECTED:
		if (old_state > BYX_CONNECTION_STATE_DISCONNECTED) {
			...
			byx_connection_cleanup (self, reason, CLEANUP_TYPE_DECONFIGURE);
		} else if (old_state < BYX_CONNECTION_STATE_DISCONNECTED) {
			if (priv->sys_iface_state == BYX_CONNECTION_SYS_IFACE_STATE_MANAGED) {
		...
		break;
	case BYX_CONNECTION_STATE_PREPARE:
		byx_connection_update_initial_hw_address (self);
		break;
	case BYX_CONNECTION_STATE_NEED_AUTH:
		if (old_state > BYX_CONNECTION_STATE_NEED_AUTH) {
	...
	if (   state >= BYX_CONNECTION_STATE_PREPARE
	    && state <= BYX_CONNECTION_STATE_ACTIVATED)
		byx_connection_autoconnect_blocked_unset (self, BYX_CONNECTION_AUTOCONNECT_BLOCKED_INTERNAL);
	...
	case BYX_CONNECTION_STATE_UNAVAILABLE:
		 ...
		 * reasons.
		 */
		if (byx_connection_is_available (self, BYX_CONNECTION_CHECK_DEV_AVAILABLE_NONE)) {
			byx_connection_queue_recheck_available (self,
			                                   BYX_CONNECTION_STATE_REASON_NONE,
			                                   BYX_CONNECTION_STATE_REASON_NONE);
		} else {
		...
		break;
	case BYX_CONNECTION_STATE_DEACTIVATING:
		_cancel_activation (self);
		...
		if (quitting) {
			...
			priv->dispatcher.post_state = BYX_CONNECTION_STATE_DISCONNECTED;
	...
	case BYX_CONNECTION_STATE_DISCONNECTED:
		...
		break;
	case BYX_CONNECTION_STATE_ACTIVATED:
	...
	case BYX_CONNECTION_STATE_FAILED:
		...
		if (byx_connection_sys_iface_state_is_external_or_assume (self)) {
			...
			byx_connection_queue_state (self,
			                       BYX_CONNECTION_STATE_ACTIVATED,
			                       BYX_CONNECTION_STATE_REASON_CONNECTION_ASSUMED);
			break;
		}
	...
	case BYX_CONNECTION_STATE_IP_CHECK:
		...
		break;
	case BYX_CONNECTION_STATE_SECONDARIES:
		ip_check_gw_ping_cleanup (self);
	...
	if (   (old_state == BYX_CONNECTION_STATE_ACTIVATED || old_state == BYX_CONNECTION_STATE_DEACTIVATING)
	    && (state != BYX_CONNECTION_STATE_DEACTIVATING)) {
		if (quitting) {
	...
	if ((old_state > BYX_CONNECTION_STATE_UNMANAGED) != (state > BYX_CONNECTION_STATE_UNMANAGED))
		_notify (self, PROP_MANAGED);
}

void
byx_connection_state_changed (ByxConnection *self,
                         ByxConnectionState state,
                         ByxConnectionStateReason reason)
{
...
queued_state_set (gpointer user_data)
{
	...
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	ByxConnectionState new_state;
	ByxConnectionStateReason new_reason;

	nm_assert (priv->queued_state.id);

	_LOGD (LOGD_DEVICE, "queue-state[%s, reason:%s, id:%u]: %s",
	       byx_connection_state_to_str (priv->queued_state.state),
	...
	byx_connection_state_changed (self, new_state, new_reason);
	byx_connection_remove_pending_action (self, queued_state_to_string (new_state), TRUE);

	return G_SOURCE_REMOVE;
}

void
byx_connection_queue_state (ByxConnection *self,
                       ByxConnectionState state,
                       ByxConnectionStateReason reason)
{
	ByxConnectionPrivate *priv;
	...
	byx_connection_add_pending_action (self, queued_state_to_string (state), TRUE);
	...
	if (priv->queued_state.id) {
		...
		byx_connection_remove_pending_action (self, queued_state_to_string (priv->queued_state.state), TRUE);
	}
...
static void
queued_state_clear (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
ByxConnectionState
byx_connection_get_state (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), BYX_CONNECTION_STATE_UNKNOWN);

	return BYX_CONNECTION_GET_PRIVATE (self)->state;
}
...
byx_connection_get_hw_address (ByxConnection *self)
{
	...
	nm_assert (   (!priv->hw_addr && priv->hw_addr_len == 0)
	           || (   priv->hw_addr
	               && _byx_utils_hwaddr_aton (priv->hw_addr, buf, sizeof (buf), &l)
	               && l == priv->hw_addr_len));
...
gboolean
byx_connection_update_hw_address (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
	const guint8 *hwaddr;
	gsize hwaddrlen = 0;
	...
	hwaddr = nm_platform_link_get_address (byx_connection_get_platform (self), priv->ifindex, &hwaddrlen);

	if (   priv->type == BYX_CONNECTION_TYPE_ETHERNET
	    && hwaddr
	    && byx_utils_hwaddr_matches (hwaddr, hwaddrlen, nm_ip_addr_zero.addr_eth, sizeof (nm_ip_addr_zero.addr_eth)))
		hwaddrlen = 0;
	...
	if (   priv->hw_addr_len
		...
		_LOGD (LOGD_PLATFORM | LOGD_DEVICE,
		       ...
		       priv->hw_addr,
		       byx_utils_hwaddr_ntoa_buf (hwaddr, hwaddrlen, TRUE, s_buf, sizeof (s_buf)));
		return FALSE;
	}

	if (   priv->hw_addr
	    && byx_utils_hwaddr_matches (priv->hw_addr, -1, hwaddr, hwaddrlen))
		return FALSE;

	g_free (priv->hw_addr);
	priv->hw_addr_len_ = hwaddrlen;
	priv->hw_addr = byx_utils_hwaddr_ntoa (hwaddr, hwaddrlen);
	...
	if (   !priv->hw_addr_initial
	    || (   priv->hw_addr_type == HW_ADDR_TYPE_UNSET
	        && priv->state < BYX_CONNECTION_STATE_PREPARE
	        && !byx_connection_is_activating (self))) {
...
void
byx_connection_update_initial_hw_address (ByxConnection *self)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
...
void
byx_connection_update_permanent_hw_address (ByxConnection *self, gboolean force_freeze)
{
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	success_read = nm_platform_link_get_permanent_address (byx_connection_get_platform (self), ifindex, buf, &len);
	if (success_read && priv->hw_addr_len == len) {
		priv->hw_addr_perm_fake = FALSE;
		priv->hw_addr_perm = byx_utils_hwaddr_ntoa (buf, len);
	 ...
	 *
	 * Note that the permanet MAC address of a ByxConnection instance does not change
	...
	if (   dev_state
		...
		_LOGD (LOGD_PLATFORM | LOGD_ETHER, "hw-addr: %s (use from statefile: %s, current: %s)",
		       ...
		       dev_state->perm_hw_addr_fake,
		       priv->hw_addr);
		priv->hw_addr_perm = byx_utils_hwaddr_ntoa (buf, priv->hw_addr_len);
		goto notify_and_out;
	}
...
static const char *
_get_cloned_mac_address_setting (ByxConnection *self, NMConnection *connection, gboolean is_wifi, char **out_addr)
{
	NMSetting *setting;
		...
		if (!a) {
			if (is_wifi) {
				...
				a = nm_config_data_get_connection_default (NM_CONFIG_GET_DATA,
				                                           ...
				                                           self);
				v = _byx_utils_ascii_str_to_int64 (a, 10,
				...
				if (v == NM_SETTING_MAC_RANDOMIZATION_ALWAYS)
		           ...
		           || byx_utils_hwaddr_valid (a, ETH_ALEN))
...
static const char *
_get_generate_mac_address_mask_setting (ByxConnection *self, NMConnection *connection, gboolean is_wifi, char **out_value)
{
	NMSetting *setting;
...
gboolean
byx_connection_hw_addr_is_explict (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
...
static gboolean
_hw_addr_matches (ByxConnection *self, const guint8 *addr, gsize addr_len)
{
	const char *cur_addr;

	cur_addr = byx_connection_get_hw_address (self);
	return cur_addr && byx_utils_hwaddr_matches (addr, addr_len, cur_addr, -1);
}

static gboolean
_hw_addr_set (ByxConnection *self,
              ...
              const char *const detail)
{
	...
	if (!_byx_utils_hwaddr_aton (addr, addr_bytes, sizeof (addr_bytes), &addr_len))
		g_return_val_if_reached (FALSE);
	...
	was_up = byx_connection_is_up (self);
	if (was_up) {
		/* Can't change MAC address while device is up */
		byx_connection_take_down (self, FALSE);
	}

	plerr = nm_platform_link_set_address (byx_connection_get_platform (self), byx_connection_get_ip_ifindex (self), addr_bytes, addr_len);
	...
	if (success) {
		...
		if (_hw_addr_matches (self, addr_bytes, addr_len)) {
			...
			poll_end = byx_utils_get_monotonic_timestamp_us () + (100 * 1000);
			for (;;) {
				if (!nm_platform_link_refresh (byx_connection_get_platform (self), byx_connection_get_ip_ifindex (self)))
					goto handle_fail;
				if (!byx_connection_update_hw_address (self))
					goto handle_wait;
				if (!_hw_addr_matches (self, addr_bytes, addr_len))
					goto handle_fail;
				...
				break;
handle_wait:
				now = byx_utils_get_monotonic_timestamp_us ();
				if (now < poll_end) {
...
handle_fail:
	...
	if (was_up) {
		if (!byx_connection_bring_up (self, TRUE, NULL))
			return FALSE;
	}
...
gboolean
byx_connection_hw_addr_set (ByxConnection *self,
                       const char *addr,
                       const char *detail,
                       gboolean set_permanent)
{
	...
	if (set_permanent) {
		/* The type is set to PERMANENT by ByxConnectionVlan when taking the MAC
		 * address from the parent and by ByxConnectionWifi when setting a random MAC
 ...
 */
static gboolean
_hw_addr_get_cloned (ByxConnection *self, NMConnection *connection, gboolean is_wifi,
                     ...
                     char **hwaddr_detail, GError **error)
{
	...
	if (nm_streq (addr, NM_CLONED_MAC_PERMANENT)) {
		...
		addr = byx_connection_get_permanent_hw_address_full (self, TRUE, &is_fake);
		if (is_fake) {
		...
		hw_addr_generated = byx_utils_hw_addr_gen_random_eth (byx_connection_get_initial_hw_address (self),
		...
		stable_id = _get_stable_id (self, connection, &stable_type);
		if (stable_id) {
			hw_addr_generated = byx_utils_hw_addr_gen_stable_eth (stable_type, stable_id,
			                                                     byx_connection_get_ip_iface (self),
			                                                     byx_connection_get_initial_hw_address (self),
		...
		if (!byx_utils_hwaddr_valid (addr, -1))
			g_return_val_if_reached (FALSE);
...
gboolean
byx_connection_hw_addr_get_cloned (ByxConnection *self, NMConnection *connection, gboolean is_wifi,
...
gboolean
byx_connection_hw_addr_set_cloned (ByxConnection *self, NMConnection *connection, gboolean is_wifi)
{
	ByxConnectionPrivate *priv;
	...
	if (preserve)
		return byx_connection_hw_addr_reset (self, detail);
...
gboolean
byx_connection_hw_addr_reset (ByxConnection *self, const char *detail)
{
	ByxConnectionPrivate *priv;
	const char *addr;
	...
	priv->hw_addr_type = HW_ADDR_TYPE_UNSET;
	addr = byx_connection_get_initial_hw_address (self);
	if (!addr) {
...
const char *
byx_connection_get_permanent_hw_address_full (ByxConnection *self, gboolean force_freeze, gboolean *out_is_fake)
{
	ByxConnectionPrivate *priv;
	...
	if (   !priv->hw_addr_perm
		 ...
		 * for UDEV. */
		byx_connection_update_permanent_hw_address (self, TRUE);
	}
...
const char *
byx_connection_get_permanent_hw_address (ByxConnection *self)
{
	return byx_connection_get_permanent_hw_address_full (self, TRUE, NULL);
}

const char *
byx_connection_get_initial_hw_address (ByxConnection *self)
{
	g_return_val_if_fail (BYX_IS_CONNECTION (self), NULL);

	return BYX_CONNECTION_GET_PRIVATE (self)->hw_addr_initial;
}

/**
 * byx_connection_spec_match_list:
 * @self: an #ByxConnection
 ...
 */
gboolean
byx_connection_spec_match_list (ByxConnection *self, const GSList *specs)
{
	return byx_connection_spec_match_list_full (self, specs, FALSE);
}

int
byx_connection_spec_match_list_full (ByxConnection *self, const GSList *specs, int no_match_value)
{
	ByxConnectionClass *klass;
	...
	m = nm_match_spec_device (specs,
	                          byx_connection_get_iface (self),
	                          byx_connection_get_type_description (self),
	                          byx_connection_get_driver (self),
	                          byx_connection_get_driver_version (self),
	                          byx_connection_get_permanent_hw_address (self),
...
guint
byx_connection_get_supplicant_timeout (ByxConnection *self)
{
	NMConnection *connection;
...
#define SUPPLICANT_DEFAULT_TIMEOUT 25
	...
	g_return_val_if_fail (BYX_IS_CONNECTION (self), SUPPLICANT_DEFAULT_TIMEOUT);
...
gboolean
byx_connection_auth_retries_try_next (ByxConnection *self)
{
	ByxConnectionPrivate *priv;
	NMSettingConnection *s_con;
	int auth_retries;
	...
	if (G_UNLIKELY (auth_retries == BYX_CONNECTION_AUTH_RETRIES_UNSET)) {
		auth_retries = -1;

		s_con = NM_SETTING_CONNECTION (byx_connection_get_applied_setting (self, NM_TYPE_SETTING_CONNECTION));
		if (s_con)
		...
		if (auth_retries == 0)
			auth_retries = BYX_CONNECTION_AUTH_RETRIES_INFINITY;
		else if (auth_retries == -1)
			auth_retries = BYX_CONNECTION_AUTH_RETRIES_DEFAULT;
		else
	...
	if (auth_retries == BYX_CONNECTION_AUTH_RETRIES_INFINITY)
		return TRUE;
	if (auth_retries <= 0) {
		nm_assert (auth_retries == 0);
		return FALSE;
...
static void
byx_connection_init (ByxConnection *self)
{
	ByxConnectionPrivate *priv;

	priv = G_TYPE_INSTANCE_GET_PRIVATE (self, BYX_TYPE_CONNECTION, ByxConnectionPrivate);
	...
	priv->autoconnect_blocked_flags = DEFAULT_AUTOCONNECT
	                                  ? BYX_CONNECTION_AUTOCONNECT_BLOCKED_NONE
	                                  : BYX_CONNECTION_AUTOCONNECT_BLOCKED_USER;

	priv->auth_retries = BYX_CONNECTION_AUTH_RETRIES_UNSET;
	priv->type = BYX_CONNECTION_TYPE_UNKNOWN;
	priv->capabilities = BYX_CONNECTION_CAP_NM_SUPPORTED;
	priv->state = BYX_CONNECTION_STATE_UNMANAGED;
	priv->state_reason = BYX_CONNECTION_STATE_REASON_NONE;
	...
	priv->sys_iface_state = BYX_CONNECTION_SYS_IFACE_STATE_EXTERNAL;
             ...
             GObjectConstructParam *construct_params)
{
	...
	klass = G_OBJECT_CLASS (byx_connection_parent_class);
	object = klass->constructor (type, n_construct_params, construct_params);
	if (!object)
		return NULL;

	self = BYX_CONNECTION (object);
	priv = BYX_CONNECTION_GET_PRIVATE (self);

	if (   priv->iface
	    && G_LIKELY (!byx_utils_get_testing ())) {
		pllink = nm_platform_link_get_by_ifname (byx_connection_get_platform (self), priv->iface);
	...
	if (priv->hw_addr_perm) {
		...
		if (!_byx_utils_hwaddr_aton (priv->hw_addr_perm, buf, sizeof (buf), &l)) {
			g_clear_pointer (&priv->hw_addr_perm, g_free);
			g_return_val_if_reached (object);
		}

		priv->hw_addr_len_ = l;
		priv->hw_addr = byx_utils_hwaddr_ntoa (buf, l);
...
{
	ByxConnection *self = BYX_CONNECTION (object);
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	NMPlatform *platform;
	...
	G_OBJECT_CLASS (byx_connection_parent_class)->constructed (object);
...
dispose (GObject *object)
{
	...
	while ((con_handle = c_list_first_entry (&priv->concheck_lst_head, ByxConnectionConnectivityHandle, concheck_lst))) {
		if (!cancelled_error)
			byx_utils_error_set_cancelled (&cancelled_error, FALSE, "ByxConnection");
	...
	G_OBJECT_CLASS (byx_connection_parent_class)->dispose (object);
...
finalize (GObject *object)
{
	...
	G_OBJECT_CLASS (byx_connection_parent_class)->finalize (object);

	/* for testing, ByxConnectionTest does not invoke ByxConnection::constructed,
...
{
	ByxConnection *self = (ByxConnection *) object;
	ByxConnectionPrivate *priv = BYX_CONNECTION_GET_PRIVATE (self);
	...
	case PROP_MANAGED:
		if (byx_connection_is_real (self)) {
			...
			if (managed) {
				...
				reason = BYX_CONNECTION_STATE_REASON_REMOVED;
				byx_connection_sys_iface_state_set (self, BYX_CONNECTION_SYS_IFACE_STATE_REMOVED);
			}
			byx_connection_set_unmanaged_by_flags (self,
			                                  NM_UNMANAGED_USER_EXPLICIT,
			                                  !managed,
	...
	case PROP_AUTOCONNECT:
		if (g_value_get_boolean (value))
			byx_connection_autoconnect_blocked_unset (self, BYX_CONNECTION_AUTOCONNECT_BLOCKED_ALL);
		else
			byx_connection_autoconnect_blocked_set (self, BYX_CONNECTION_AUTOCONNECT_BLOCKED_USER);
		break;
	...
	case PROP_DEVICE_TYPE:
		/* construct-only */
		nm_assert (priv->type == BYX_CONNECTION_TYPE_UNKNOWN);
              ...
              GValue *value, GParamSpec *pspec)
{
	...
	case PROP_UDI:
		...
		g_value_take_string (value,
		                     byx_utils_str_utf8safe_escape_cp (priv->udi,
		                                                      NM_UTILS_STR_UTF8_SAFE_FLAG_NONE));
		break;
	case PROP_IFACE:
		g_value_take_string (value,
		                     byx_utils_str_utf8safe_escape_cp (priv->iface,
		                                                      NM_UTILS_STR_UTF8_SAFE_FLAG_ESCAPE_CTRL));
		break;
	case PROP_IP_IFACE:
		if (ip_config_valid (priv->state)) {
			g_value_take_string (value,
			                     byx_utils_str_utf8safe_escape_cp (byx_connection_get_ip_iface (self),
			                                                      NM_UTILS_STR_UTF8_SAFE_FLAG_ESCAPE_CTRL));
		} else
	...
	case PROP_DRIVER:
		g_value_take_string (value,
		                     byx_utils_str_utf8safe_escape_cp (priv->driver,
		                                                      NM_UTILS_STR_UTF8_SAFE_FLAG_ESCAPE_CTRL));
		break;
	case PROP_DRIVER_VERSION:
		g_value_take_string (value,
		                     byx_utils_str_utf8safe_escape_cp (priv->driver_version,
		                                                      NM_UTILS_STR_UTF8_SAFE_FLAG_ESCAPE_CTRL));
		break;
	case PROP_FIRMWARE_VERSION:
		g_value_take_string (value,
		                     byx_utils_str_utf8safe_escape_cp (priv->firmware_version,
		                                                      NM_UTILS_STR_UTF8_SAFE_FLAG_ESCAPE_CTRL));
		break;
	case PROP_CAPABILITIES:
		g_value_set_uint (value, (priv->capabilities & ~BYX_CONNECTION_CAP_INTERNAL_MASK));
		break;
	case PROP_IP4_ADDRESS:
	...
	case PROP_MANAGED:
		...
		g_value_set_boolean (value, byx_connection_get_state (self) > BYX_CONNECTION_STATE_UNMANAGED);
		break;
	case PROP_AUTOCONNECT:
		g_value_set_boolean (value,
		                     byx_connection_autoconnect_blocked_get (self, BYX_CONNECTION_AUTOCONNECT_BLOCKED_ALL)
		                       ? FALSE
		                       : TRUE);
		break;
	case PROP_FIRMWARE_MISSING:
	...
	case PROP_PHYSICAL_PORT_ID:
		...
		break;
	case PROP_MASTER:
		g_value_set_object (value, byx_connection_get_master (self));
		break;
	case PROP_PARENT:
	...
	case PROP_PERM_HW_ADDRESS: {
		...
		perm_hw_addr = byx_connection_get_permanent_hw_address_full (self, FALSE, &perm_hw_addr_is_fake);
		/* this property is exposed on D-Bus for ByxConnectionEthernet and ByxConnectionWifi. */
		g_value_set_string (value, perm_hw_addr && !perm_hw_addr_is_fake ? perm_hw_addr : NULL);
		break;
	}
	case PROP_HAS_PENDING_ACTION:
		g_value_set_boolean (value, byx_connection_has_pending_action (self));
		break;
	case PROP_METERED:
	...
	case PROP_LLDP_NEIGHBORS:
		...
		break;
	case PROP_REAL:
		g_value_set_boolean (value, byx_connection_is_real (self));
		break;
	case PROP_SLAVES: {
		CList *slave_iter;
		char **slave_list;
...
static const ByxDBusInterfaceInfoExtended interface_info_device = {
	.parent = NM_DEFINE_GDBUS_INTERFACE_INFO_INIT (
		...
		.properties = NM_DEFINE_GDBUS_PROPERTY_INFOS (
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Udi",                  "s",      BYX_CONNECTION_UDI),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Interface",            "s",      BYX_CONNECTION_IFACE),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("IpInterface",          "s",      BYX_CONNECTION_IP_IFACE),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Driver",               "s",      BYX_CONNECTION_DRIVER),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("DriverVersion",        "s",      BYX_CONNECTION_DRIVER_VERSION),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("FirmwareVersion",      "s",      BYX_CONNECTION_FIRMWARE_VERSION),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Capabilities",         "u",      BYX_CONNECTION_CAPABILITIES),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Ip4Address",           "u",      BYX_CONNECTION_IP4_ADDRESS),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("State",                "u",      BYX_CONNECTION_STATE),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("StateReason",          "(uu)",   BYX_CONNECTION_STATE_REASON),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("ActiveConnection",     "o",      BYX_CONNECTION_ACTIVE_CONNECTION),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Ip4Config",            "o",      BYX_CONNECTION_IP4_CONFIG),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Dhcp4Config",          "o",      BYX_CONNECTION_DHCP4_CONFIG),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Ip6Config",            "o",      BYX_CONNECTION_IP6_CONFIG),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Dhcp6Config",          "o",      BYX_CONNECTION_DHCP6_CONFIG),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READWRITABLE_L ("Managed",              "b",      BYX_CONNECTION_MANAGED,               NM_AUTH_PERMISSION_NETWORK_CONTROL, NM_AUDIT_OP_DEVICE_MANAGED),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READWRITABLE_L ("Autoconnect",          "b",      BYX_CONNECTION_AUTOCONNECT,           NM_AUTH_PERMISSION_NETWORK_CONTROL, NM_AUDIT_OP_DEVICE_AUTOCONNECT),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("FirmwareMissing",      "b",      BYX_CONNECTION_FIRMWARE_MISSING),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("NmPluginMissing",      "b",      BYX_CONNECTION_NM_PLUGIN_MISSING),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("DeviceType",           "u",      BYX_CONNECTION_DEVICE_TYPE),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("AvailableConnections", "ao",     BYX_CONNECTION_AVAILABLE_CONNECTIONS),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("PhysicalPortId",       "s",      BYX_CONNECTION_PHYSICAL_PORT_ID),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Mtu",                  "u",      BYX_CONNECTION_MTU),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Metered",              "u",      BYX_CONNECTION_METERED),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("LldpNeighbors",        "aa{sv}", BYX_CONNECTION_LLDP_NEIGHBORS),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE_L     ("Real",                 "b",      BYX_CONNECTION_REAL),
		),
	),
};

const ByxDBusInterfaceInfoExtended nm_interface_info_device_statistics = {
	.parent = NM_DEFINE_GDBUS_INTERFACE_INFO_INIT (
		...
		.properties = NM_DEFINE_GDBUS_PROPERTY_INFOS (
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READWRITABLE ("RefreshRateMs", "u", BYX_CONNECTION_STATISTICS_REFRESH_RATE_MS, NM_AUTH_PERMISSION_ENABLE_DISABLE_STATISTICS, NM_AUDIT_OP_STATISTICS),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE     ("TxBytes",       "t", BYX_CONNECTION_STATISTICS_TX_BYTES),
			NM_DEFINE_DBUS_PROPERTY_INFO_EXTENDED_READABLE     ("RxBytes",       "t", BYX_CONNECTION_STATISTICS_RX_BYTES),
		),
	),
};

static void
byx_connection_class_init (ByxConnectionClass *klass)
{
	GObjectClass *object_class = G_OBJECT_CLASS (klass);
	ByxDBusObjectClass *dbus_object_class = NM_DBUS_OBJECT_CLASS (klass);

	g_type_class_add_private (object_class, sizeof (ByxConnectionPrivate));
	...
	obj_properties[PROP_UDI] =
	    g_param_spec_string (BYX_CONNECTION_UDI, "", "",
	                         NULL,
	                         G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_IFACE] =
	    g_param_spec_string (BYX_CONNECTION_IFACE, "", "",
	                         NULL,
	                         G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_IP_IFACE] =
	    g_param_spec_string (BYX_CONNECTION_IP_IFACE, "", "",
	                         NULL,
	                         G_PARAM_READABLE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_DRIVER] =
	    g_param_spec_string (BYX_CONNECTION_DRIVER, "", "",
	                         NULL,
	                         G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_DRIVER_VERSION] =
	    g_param_spec_string (BYX_CONNECTION_DRIVER_VERSION, "", "",
	                         NULL,
	                         G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_FIRMWARE_VERSION] =
	    g_param_spec_string (BYX_CONNECTION_FIRMWARE_VERSION, "", "",
	                         NULL,
	                         G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_CAPABILITIES] =
	    g_param_spec_uint (BYX_CONNECTION_CAPABILITIES, "", "",
	                       0, G_MAXUINT32, BYX_CONNECTION_CAP_NONE,
	                       G_PARAM_READABLE |
	                       G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_CARRIER] =
	    g_param_spec_boolean (BYX_CONNECTION_CARRIER, "", "",
	                          FALSE,
	                          G_PARAM_READABLE |
	                          G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_MTU] =
	    g_param_spec_uint (BYX_CONNECTION_MTU, "", "",
	                       0, G_MAXUINT32, 1500,
	                       G_PARAM_READABLE |
	                       G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_IP4_ADDRESS] =
	    g_param_spec_uint (BYX_CONNECTION_IP4_ADDRESS, "", "",
	                       0, G_MAXUINT32, 0, /* FIXME */
	                       G_PARAM_READWRITE |
	                       G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_IP4_CONFIG] =
	    g_param_spec_string (BYX_CONNECTION_IP4_CONFIG, "", "",
	                         NULL,
	                         G_PARAM_READWRITE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_DHCP4_CONFIG] =
	    g_param_spec_string (BYX_CONNECTION_DHCP4_CONFIG, "", "",
	                         NULL,
	                         G_PARAM_READWRITE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_IP6_CONFIG] =
	    g_param_spec_string (BYX_CONNECTION_IP6_CONFIG, "", "",
	                         NULL,
	                         G_PARAM_READWRITE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_DHCP6_CONFIG] =
	    g_param_spec_string (BYX_CONNECTION_DHCP6_CONFIG, "", "",
	                         NULL,
	                         G_PARAM_READWRITE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_STATE] =
	    g_param_spec_uint (BYX_CONNECTION_STATE, "", "",
	                       0, G_MAXUINT32, BYX_CONNECTION_STATE_UNKNOWN,
	                       G_PARAM_READABLE |
	                       G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_STATE_REASON] =
	    g_param_spec_variant (BYX_CONNECTION_STATE_REASON, "", "",
	                          G_VARIANT_TYPE ("(uu)"),
	                          NULL,
	                          G_PARAM_READABLE |
	                          G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_ACTIVE_CONNECTION] =
	    g_param_spec_string (BYX_CONNECTION_ACTIVE_CONNECTION, "", "",
	                         NULL,
	                         G_PARAM_READABLE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_DEVICE_TYPE] =
	    g_param_spec_uint (BYX_CONNECTION_DEVICE_TYPE, "", "",
	                       0, G_MAXUINT32, BYX_CONNECTION_TYPE_UNKNOWN,
	                       G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                       G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_LINK_TYPE] =
	    g_param_spec_uint (BYX_CONNECTION_LINK_TYPE, "", "",
	                       0, G_MAXUINT32, NM_LINK_TYPE_NONE,
	                       G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                       G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_MANAGED] =
	    g_param_spec_boolean (BYX_CONNECTION_MANAGED, "", "",
	                          FALSE,
	                          G_PARAM_READWRITE |
	                          G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_AUTOCONNECT] =
	    g_param_spec_boolean (BYX_CONNECTION_AUTOCONNECT, "", "",
	                          DEFAULT_AUTOCONNECT,
	                          G_PARAM_READWRITE |
	                          G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_FIRMWARE_MISSING] =
	    g_param_spec_boolean (BYX_CONNECTION_FIRMWARE_MISSING, "", "",
	                          FALSE,
	                          G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                          G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_NM_PLUGIN_MISSING] =
	    g_param_spec_boolean (BYX_CONNECTION_NM_PLUGIN_MISSING, "", "",
	                          FALSE,
	                          G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                          G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_TYPE_DESC] =
	    g_param_spec_string (BYX_CONNECTION_TYPE_DESC, "", "",
	                         NULL,
	                         G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_RFKILL_TYPE] =
	    g_param_spec_uint (BYX_CONNECTION_RFKILL_TYPE, "", "",
	                       RFKILL_TYPE_WLAN,
	                       RFKILL_TYPE_MAX,
	                       RFKILL_TYPE_UNKNOWN,
	                       G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	...
	obj_properties[PROP_IFINDEX] =
	    g_param_spec_int (BYX_CONNECTION_IFINDEX, "", "",
	                      0, G_MAXINT, 0,
	                      G_PARAM_READABLE |
	                      G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_AVAILABLE_CONNECTIONS] =
	    g_param_spec_boxed (BYX_CONNECTION_AVAILABLE_CONNECTIONS, "", "",
	                        G_TYPE_STRV,
	                        G_PARAM_READABLE |
	                        G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_PHYSICAL_PORT_ID] =
	    g_param_spec_string (BYX_CONNECTION_PHYSICAL_PORT_ID, "", "",
	                         NULL,
	                         G_PARAM_READABLE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_MASTER] =
	    g_param_spec_object (BYX_CONNECTION_MASTER, "", "",
	                         BYX_TYPE_CONNECTION,
	                         G_PARAM_READABLE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_PARENT] =
	    g_param_spec_string (BYX_CONNECTION_PARENT, "", "",
	                         NULL,
	                         G_PARAM_READABLE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_HW_ADDRESS] =
	    g_param_spec_string (BYX_CONNECTION_HW_ADDRESS, "", "",
	                         NULL,
	                         G_PARAM_READABLE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_PERM_HW_ADDRESS] =
	    g_param_spec_string (BYX_CONNECTION_PERM_HW_ADDRESS, "", "",
	                         NULL,
	                         G_PARAM_READWRITE | G_PARAM_CONSTRUCT_ONLY |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_HAS_PENDING_ACTION] =
	    g_param_spec_boolean (BYX_CONNECTION_HAS_PENDING_ACTION, "", "",
	                          FALSE,
	                          G_PARAM_READABLE |
	                          G_PARAM_STATIC_STRINGS);

	/**
	 * ByxConnection:metered:
	 *
	...
	obj_properties[PROP_METERED] =
	    g_param_spec_uint (BYX_CONNECTION_METERED, "", "",
	                       0, G_MAXUINT32, NM_METERED_UNKNOWN,
	                       G_PARAM_READABLE |
	                       G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_LLDP_NEIGHBORS] =
	    g_param_spec_variant (BYX_CONNECTION_LLDP_NEIGHBORS, "", "",
	                          G_VARIANT_TYPE ("aa{sv}"),
	                          NULL,
	                          G_PARAM_READABLE |
	                          G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_REAL] =
	    g_param_spec_boolean (BYX_CONNECTION_REAL, "", "",
	                          FALSE,
	                          G_PARAM_READABLE |
	                          G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_SLAVES] =
	    g_param_spec_boxed (BYX_CONNECTION_SLAVES, "", "",
	                        G_TYPE_STRV,
	                        G_PARAM_READABLE |
	                        G_PARAM_STATIC_STRINGS);

	obj_properties[PROP_REFRESH_RATE_MS] =
	    g_param_spec_uint (BYX_CONNECTION_STATISTICS_REFRESH_RATE_MS, "", "",
	                       0, UINT32_MAX, 0,
	                       G_PARAM_READWRITE |
	                       G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_TX_BYTES] =
	    g_param_spec_uint64 (BYX_CONNECTION_STATISTICS_TX_BYTES, "", "",
	                         0, UINT64_MAX, 0,
	                         G_PARAM_READABLE |
	                         G_PARAM_STATIC_STRINGS);
	obj_properties[PROP_RX_BYTES] =
	    g_param_spec_uint64 (BYX_CONNECTION_STATISTICS_RX_BYTES, "", "",
	                         0, UINT64_MAX, 0,
	                         G_PARAM_READABLE |
	                         G_PARAM_STATIC_STRINGS);

	obj_properties[PROP_CONNECTIVITY] =
	     g_param_spec_uint (BYX_CONNECTION_CONNECTIVITY, "", "",
	...
	signals[STATE_CHANGED] =
	    g_signal_new (BYX_CONNECTION_STATE_CHANGED,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_LAST,
	                  G_STRUCT_OFFSET (ByxConnectionClass, state_changed),
	                  NULL, NULL, NULL,
	                  G_TYPE_NONE, 3,
	                  G_TYPE_UINT, G_TYPE_UINT, G_TYPE_UINT);

	signals[AUTOCONNECT_ALLOWED] =
	    g_signal_new (BYX_CONNECTION_AUTOCONNECT_ALLOWED,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_LAST,
	                  0,
	...
	signals[AUTH_REQUEST] =
	    g_signal_new (BYX_CONNECTION_AUTH_REQUEST,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL, NULL,
	...
	signals[IP4_CONFIG_CHANGED] =
	    g_signal_new (BYX_CONNECTION_IP4_CONFIG_CHANGED,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL, NULL,
	...
	signals[IP6_CONFIG_CHANGED] =
	    g_signal_new (BYX_CONNECTION_IP6_CONFIG_CHANGED,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL, NULL,
	                  G_TYPE_NONE, 2, G_TYPE_OBJECT, G_TYPE_OBJECT);
	...
	signals[IP6_PREFIX_DELEGATED] =
	    g_signal_new (BYX_CONNECTION_IP6_PREFIX_DELEGATED,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL, NULL,
	...
	signals[IP6_SUBNET_NEEDED] =
	    g_signal_new (BYX_CONNECTION_IP6_SUBNET_NEEDED,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL, NULL,
	                  G_TYPE_NONE, 0);
	...
	signals[REMOVED] =
	    g_signal_new (BYX_CONNECTION_REMOVED,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL, NULL,
	                  G_TYPE_NONE, 0);
	...
	signals[RECHECK_AUTO_ACTIVATE] =
	    g_signal_new (BYX_CONNECTION_RECHECK_AUTO_ACTIVATE,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL, NULL,
	                  G_TYPE_NONE, 0);
	...
	signals[RECHECK_ASSUME] =
	    g_signal_new (BYX_CONNECTION_RECHECK_ASSUME,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL, NULL,
	                  G_TYPE_NONE, 0);
	...
	signals[CONNECTIVITY_CHANGED] =
	    g_signal_new (BYX_CONNECTION_CONNECTIVITY_CHANGED,
	                  G_OBJECT_CLASS_TYPE (object_class),
	                  G_SIGNAL_RUN_FIRST,
	                  0, NULL, NULL,

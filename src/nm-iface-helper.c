...
#define _NMLOG(level, domain, ...) \
    byx_log ((level), (domain), global_opt.ifname, NULL, \
...
ndisc_config_changed (NMNDisc *ndisc, const NMNDiscData *rdata, guint changed_int, gpointer user_data)
{
	...
	if (changed & NM_NDISC_CONFIG_MTU) {
		...
		nm_platform_sysctl_set (NM_PLATFORM_GET, NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, sysctl_path_buf, global_opt.ifname, "mtu")), val);
	}
...
main (int argc, char *argv[])
{
	...
	byx_logging_set_syslog_identifier ("nm-iface-helper");
	byx_logging_set_prefix ("%s[%ld] (%s): ",
	                       _NMLOG_PREFIX_NAME,
	                       (long) getpid (),
	                       global_opt.ifname ?: "???");
	...
	byx_main_utils_ensure_not_running_pidfile (pidfile);
	...
	byx_logging_syslog_openlog (global_opt.logging_backend,
	                           global_opt.debug);
	...
	if (global_opt.iid_str) {
		...
		bytes = byx_utils_hexstr2bin (global_opt.iid_str);
	...
	if (global_opt.dhcp4_clientid) {
		...
		client_id = byx_utils_hexstr2bin (global_opt.dhcp4_clientid);
	...
	if (global_opt.dhcp4_address) {
		nm_platform_sysctl_set (NM_PLATFORM_GET, NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET, sysctl_path_buf, global_opt.ifname, "promote_secondaries")), "1");
	...
	if (global_opt.slaac) {
		...
		nm_platform_sysctl_set (NM_PLATFORM_GET, NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, sysctl_path_buf, global_opt.ifname, "accept_ra")), "1");
		nm_platform_sysctl_set (NM_PLATFORM_GET, NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, sysctl_path_buf, global_opt.ifname, "accept_ra_defrtr")), "0");
		nm_platform_sysctl_set (NM_PLATFORM_GET, NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, sysctl_path_buf, global_opt.ifname, "accept_ra_pinfo")), "0");
		nm_platform_sysctl_set (NM_PLATFORM_GET, NMP_SYSCTL_PATHID_ABSOLUTE (byx_utils_sysctl_ip_conf_path (AF_INET6, sysctl_path_buf, global_opt.ifname, "accept_ra_rtr_pref")), "0");

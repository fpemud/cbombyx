...
BYX_MANAGER_IFACE = "org.freedesktop.NetworkManager"
...
manager = dbus.Interface(proxy, BYX_MANAGER_IFACE)
...
try:
    ctype = props.Get(BYX_MANAGER_IFACE, "PrimaryConnectionType")
...
try:
    primary = props.Get(BYX_MANAGER_IFACE, "PrimaryConnection")
    if not primary:
...
active = props.Get(BYX_MANAGER_IFACE, "ActiveConnections")
for a in active:
